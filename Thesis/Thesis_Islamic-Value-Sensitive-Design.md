...
# Islamic Value-Sensitive Design: A Framework for Provider-Mediated Software Solutions
...
The complete set of Markdown files, technical implementations, agentic skill materials, assets, scripts, and related thesis work is hosted in Git repositories under [github.com/islamu-ngo](https://github.com/islamu-ngo). Access has been granted to the evaluation committee.

This repository is multi-licensed.

### Thesis, Paper Text, Framework Tables, Diagrams, and README Documentation

Unless stated otherwise, the thesis text, framework documentation, diagrams, and educational materials are licensed under Creative Commons Attribution 4.0 International (CC BY 4.0).

Islamic Value-Sensitive Design Moral Framework © 2026 by Amir Akrari / ISLAMU is licensed under Creative Commons Attribution 4.0 International. To view a copy of this license, visit https://creativecommons.org/licenses/by/4.0/

### Agentic Skill, Scripts, Implementation Files, and Software-Like Materials

Unless stated otherwise, software, automation scripts, agentic skill implementation files, configuration templates, and code-like files are licensed under GNU Affero General Public License v3.0 or later (AGPL-3.0-or-later).

Copyright © 2026 ISLAMU ASBL and contributors.

This includes the Agentic Skill and related technical implementation materials connected to the thesis.
...
The framework is illustrated through ISLAMU Event as a single case-based application. The case shows how I-VSD can structure design reasoning about curation, anti-scam safeguards, privacy, payments, openness, federation, and long-term stewardship. Current repository and documentation evidence strengthen the case as implementation-traceability evidence and a worked example, not full empirical validation across all software categories. The thesis contributes a reusable framework for morally accountable software provision and identifies future validation paths through additional cases, practitioner review, stakeholder research, and operational evaluation.
...
- **Classical Islamic Scholarship** - Works of recognized scholars such as Imam al-Ghazali, Al-Shatibi, Ibn Taymiyyah, and the four Madhabs, used especially for moral character, maqasid, public responsibility, and governance questions
...
The contemporary software industry faces ethical challenges that affect users across many contexts. While software can support innovation and progress, misaligned incentives throughout development, deployment, and diffusion often lead to harmful outcomes (Center for Humane Technology, n.d.). These include privacy violations, data breaches, manipulative design patterns, and unfair business practices.

Moral and ethical standards in software business extend beyond compliance. Ethical business practices can help earn and maintain trust, support retention, generate word-of-mouth recommendations, create more sustainable marketing value, and build long-term business resilience.

Despite these possible benefits, the industry continues to show patterns of behavior that prioritize short-term profit over welfare and moral responsibility. This thesis addresses that problem by proposing an Islamic provider-responsibility framework that translates selected Islamic ethical commitments into design, technical, operational, governance, and evaluation responsibilities across the software lifecycle.
...
This is why the thesis treats trust as a software-design concern. Ethical failures in the industry do not merely create isolated scandals; they reshape how users evaluate software, how much verification burden they assume, and how much freedom they need before they feel safe.
...
![figure 1.2 Main Research Question](../30-Resources/Thesis/figure_1.2-Main-Research-Question.png)
...
The case-study goal is included because a moral software framework has limited practical value if it remains only a theoretical statement of future intentions. ISLAMU Event provides a bounded way to show whether the framework can actually shape decisions made by the author in a real software project. The case material includes thesis reasoning alongside current repository and documentation evidence where available, so the contribution is best understood as implementation traceability rather than only speculative design. In that sense, the case adds evidence of seriousness, traceability, and practical plausibility. It does not by itself prove adoption, market viability, stakeholder satisfaction, or general framework effectiveness.
...
**Value:** Something treated as morally or socially important in the design and governance of a provider-mediated software solution. In this thesis, values may be identified through stakeholders and design analysis, but Islamic values receive their normative weight from the selected Islamic ethical sources used within the stated scope of the framework.

**Principle:** A mid-level ethical rule or orientation derived from one or more values. Principles such as Trust, Truthfulness, Justice, Non-Harm, Promise-Keeping, and Avoiding Spying are used in this thesis to guide software-provider responsibilities without claiming to issue complete religious-legal rulings.

**Norm:** A more specific expectation, permission, obligation, or prohibition that follows from a principle in a particular design context. For example, a general privacy value may generate a norm against unnecessary tracking in a product context where tracking is not needed for the service.

**Requirement:** A design, technical, operational, or governance condition that a provider-mediated software solution should satisfy in order to express a relevant principle. Requirements are more concrete than values or principles and can be reviewed against artifacts such as interface flows, architecture decisions, policies, or audit records.

**Metric:** A measurable or inspectable indicator used to evaluate whether a requirement is being satisfied. Metrics can be quantitative, such as error rates or response times, or qualitative/structured, such as audit findings, stakeholder feedback themes, or evidence that a review procedure was followed.

**Control:** A technical or governance mechanism used to satisfy, enforce, or monitor a requirement. Examples include access controls, retention limits, review gates, appeal procedures, audit logs, incident-response processes, and documentation duties.

**Constraint:** A boundary on the permissible design space. Some constraints are practical or legal; in I-VSD, some are also ethical non-negotiables where a provider should not trade the boundary away merely because another stakeholder preference or business objective would benefit.

**Trade-off:** A deliberate balancing between competing values, requirements, or metrics. In this thesis, trade-offs are acceptable only when they are explicit, justified, evidence-aware, and bounded by non-negotiable constraints; they are not a license to override Islamic ethical boundaries or unsupported stakeholder rights.
...
**Sources:**
- Imam al-Ghazali's Principles of Selling (Video lecture): https://www.youtube.com/watch?v=VZLkFCzJw4c&t=53s
- 6 Things That Can Make Your Business Forbidden: https://youtu.be/7V_01TVNkCA?si=FeKrOGpy7MwygSxe

#### 2.1.2 The Principle of Dual-Use Services and Assisting in Sin

**The Core Principle: Assisting in Sin (_Prohibition Against Assisting in Sin_)**

A relevant consideration in Islamic ethics is the prohibition against contributing to evil or assisting in sinful activities. The foundational Quranic evidence states:

> "...And cooperate in righteousness and piety, but do not cooperate in sin and aggression..." **Quran 5:2**

However, Islamic scholars distinguish between **direct/intentional** assistance and **indirect/unintentional** assistance. This distinction is important for evaluating modern software services that may have both legitimate and illegitimate uses.
...
1. The action provides a neutral service (routing traffic)
2. The intent is to help people bypass censorship (Permissible), not to help criminals (Forbidden)
3. The provider cannot know who is using it, and the tool has substantial legitimate uses
...
This section uses documented and representative software-industry harms to motivate the need for I-VSD as an Islamic provider-responsibility framework. It is not intended to make the main chapter an exhaustive state-of-the-industry report. The full restored catalogue of concrete examples and source notes is preserved in Appendix D: Extended Evidence Catalogue. The examples matter because they reveal recurring value tensions that provider-mediated software solutions must address.

For the main argument, the catalogue is organized into eight harm types. These types will later be translated into I-VSD heuristics rather than treated as isolated scandals.

| Harm Type | Design-Relevant Problem | Typical I-VSD Response |
| --- | --- | --- |
| 1. Deception and manipulation | Users are misled through false claims, dark patterns, fake urgency, hidden sponsorship, fabricated reviews, or unclear product limits. | Truthfulness, Deception, Excessive Uncertainty, and Promise-Keeping require truthful communication, clear terms, honest interfaces, and preserved commitments. |
| 2. Privacy, surveillance, and data misuse | Providers collect, infer, share, or expose data beyond legitimate need or user expectation. | Trust and avoiding Spying require minimization, transparency, access control, retention limits, and privacy review. |
| 3. Lock-in, portability failure, and dependency abuse | Users, communities, or competitors are trapped through closed formats, migration barriers, hostile licensing changes, or ecosystem control. | Justice, Trust, and Promise-Keeping require fair exit paths, portability, interoperability, and durable commitments. |
| 4. Exploitative monetization and pricing opacity | Revenue models exploit confusion, urgency, religious guilt, addiction, unfair payment terms, or hidden costs. | Avoiding Interest/Usury, Excessive Uncertainty, Deception, and Non-Harm requires clear pricing, non-coercive monetization, and review of business incentives. |
| 5. Algorithmic opacity, recommender harm, and AI hallucination | Automated systems shape user belief, attention, ranking, or decisions without adequate transparency, accountability, or source integrity. | Trust, Truthfulness, Justice, and Non-Harm require disclosure, source integrity, bias review, autonomy protection, and evidence-level limits. |
| 6. Security negligence and breach responsibility | Providers accept sensitive trust but underinvest in security, verification, incident response, or fraud prevention. | Trust, Non-Harm, and Excellence require reasonable safeguards, operational readiness, and review of foreseeable misuse. |
| 7. Content integrity, moderation, and community harm | Platforms host, rank, sell, legitimize, or suppress content in ways that harm communities or apply standards inconsistently. | Justice, Truthfulness, Non-Harm, and Modesty require consistent moderation, appeal paths, harm ranking, and community-specific review. |
| 8. Source and provenance failure in religious or knowledge systems | Software presents knowledge, religious material, reviews, AI text, or claimed expertise without adequate provenance, uncertainty, or authenticity controls. | Trust, Truthfulness, and Excellence require citation, provenance, uncertainty communication, and caution around religious or expert claims. |

![figure 2.1.3 Representative Software Harms and I VSD Motivation](../30-Resources/Thesis/figure 2.1.3 Representative Software Harms and I-VSD Motivation.png)

**Figure 2.1: Anti-pattern-to-I-VSD response map.** Chapter 2 is used to identify recurring harm patterns and the corresponding ethical response areas. The figure keeps the chapter focused on framework motivation while the detailed catalogue remains available in Appendix D.

The child sections below preserve the source material and representative examples used to build the typology. They should be used selectively in the thesis body. Where a subsection contains material outside the thesis's provider-mediated software scope, it should be treated as appendix material, future research, or background rather than as part of the main argument.

- 2.1.3.A Labor and Exploitation Violations - use only where labor pressure shapes software design accountability or governance.
- 2.1.3.B Deception and Fraud - direct evidence for deception, dark patterns, false claims, pricing opacity, and review manipulation.
- 2.1.3.C Data, Privacy and Security Violations - direct evidence for privacy, surveillance, and security responsibility.
- 2.1.3.D Transparency and Business Practice Violations - direct evidence for terms, business practices, lock-in, and provider communication.
- 2.1.3.E Platform Abuse and User Exploitation - direct evidence for platform power, monetization, and user exploitation.
- 2.1.3.F Technical and AI System Violations - direct evidence for AI, automation, security, billing, and technical opacity.
- 2.1.3.G Market Dynamics and Systemic Bias - use only where market dynamics affect user choice, lock-in, fairness, or design accountability.
- 2.1.3.H Governance, Ecosystem Integrity, and Scope-Limited Organizational Pressures - summarized in the main chapter while the full original catalogue is preserved in Appendix D.
- 2.1.3.Z Islamic Perspective Summary - consolidated Islamic-ethical bridge from the harm typology to I-VSD.
...
![number of dark patterns found pie chart](../30-Resources/Thesis/number of dark patterns found pie-chart.png)
...
| Reliance on obscurity, hidden source code, or unexamined internal complexity as a security boundary. | Cheap scanning, source-code leaks, supply-chain compromise, and AI-assisted analysis can make hidden flaws discoverable faster than a provider can react. | Design security so exposure does not collapse the system: least privilege, tenant isolation, secret rotation, dependency review, CI/CD hardening, and tested incident response. |
...
Security and privacy examples should be used carefully. A vulnerability report, smart-device surveillance case, practitioner warning about security by obscurity, or cloud data-loss incident can motivate the framework, but the thesis should not claim a complete empirical survey of all providers. The design lesson is that I-VSD must ask whether the provider can justify data collection, protect what it stores, explain what it does, and give users realistic routes to export, recovery, and refusal.

**Representative source anchors:** Open Source Initiative definition; Ars Technica report on Google Cloud account deletion; smart-vacuum surveillance reporting; Bugaev's practitioner article on the decline of security by obscurity; security-vulnerability and patching examples requiring final source verification before submission.
...
| Post-contract dependency exploitation in custom software delivery. | A client may agree to a scope and price, then become dependent on a provider who delays delivery, withholds promised work, or designs ordinary modifications to require paid provider intervention. | Treat delivery promises, maintainability, change paths, and dependency risks as part of the ethical transaction, not merely post-sale implementation details. |
...
Transparency is not only a matter of legal fine print. In software, the user often depends on the provider's interface to understand what is owned, rented, licensed, tracked, included, excluded, comparable, revocable, maintainable, or dependent on future provider intervention. I-VSD therefore treats product pages, pricing tables, review displays, comparison matrices, terms summaries, delivery promises, maintenance assumptions, and in-app notices as morally relevant design artifacts.
...
| Provider-shaped terminology that treats normal user-controlled installation, repair, export, or interoperability as suspicious or deviant. | Language can normalize platform control by making user autonomy sound unsafe by default, even when the underlying action is a legitimate function of the device or software environment. | Review security language for proportionality, distinguish real risk from control-preserving framing, and preserve user agency where risk can be managed through transparent warnings and accountable safeguards. |
...
Communication can intensify this dependency. If a dominant provider successfully frames ordinary user-controlled installation or alternative distribution as inherently suspect, less technical users may internalize the provider's preferred channel as the only legitimate path. Security warnings can be necessary, but I-VSD asks whether they inform users about real risk or strategically delegitimize alternatives that would otherwise reduce platform power.
...
![figure 2.3 harm principle bridge](../30-Resources/Thesis/figure_2.3_harm-principle-bridge.png)
...
MonoGame illustrates how value-aligned open-source infrastructure can attract support from beneficiaries of the ecosystem. MonoGame, an open-source C# framework and successor to Microsoft's XNA tradition, announced in 2025 that ConcernedApe, the developer of *Stardew Valley*, made a $125,000 initial donation and an ongoing monthly commitment. MonoGame framed this support as helping ensure that it remains an open-source C# framework that game developers of all sizes can rely on.
...
The inverse risk is that a software product can become financially attractive precisely because it has not yet been optimized for extraction. A later ownership change, acquisition, or investor-led restructuring may identify unused pricing power, captive users, under-monetized data, or weak exit options as opportunities for short-term return. This thesis should not claim that every acquisition or private-equity transaction necessarily destroys software quality. The narrower point is that ownership incentives are ethically relevant: when new owners inherit user dependence, they may be tempted to convert accumulated trust into price increases, reduced support, feature removal, or stronger lock-in.

#### Cautionary counterpoint: mission alignment still requires operational consistency

Mission-oriented or nonprofit-backed software organizations can also weaken user trust when their public commitments become ambiguous. Mozilla's 2025 Firefox Terms of Use and Privacy Notice update illustrates this point in a bounded way: Mozilla introduced formal terms and a more detailed privacy notice, community concern focused on broad license and data-use language, and Mozilla then published an update narrowing the wording and clarifying that the language was meant to describe what Firefox needs to operate. The case should not be used as proof of malicious intent or corruption, but it does show why value-driven organizations must maintain clear, inspectable alignment between public promises, legal wording, product features, advertising/data practices, and user expectations.

#### 2.1.4.1 Case Study: Pinterest - Child Safety Over Growth Metrics

Bill Ready, CEO of Pinterest, faced a critical decision in his first months leading the company: making Pinterest accounts private-only for users under 16 years old. The industry narrative claimed Pinterest was "aging up and aging out," senior leadership warned the change would alienate young users, concerns arose about hindering growth, and fears emerged about losing competitiveness with other platforms.

Ready's reasoning was clear: "What I saw – both as a leader and as a parent – was that no level of engagement metric was worth compromising safety for kids. After a series of disturbing revelations across the broader industry about child safety on social platforms, one thing became clear to me: social media, as currently configured, is simply not safe for kids under 16. Giving minors a public profile and the ability to be found or contacted by strangers was not only risky, but unacceptable."

The backlash was immediate: stock price dropped sharply, critics warned of losing relevance with Gen Z, and internal resistance arose from growth-focused teams. However, later outcomes supported the decision: Gen Z became Pinterest's fastest-growing demographic and now comprises over 50% of users. Users cite Pinterest as "an oasis away from the toxicity they encounter elsewhere," suggesting that the safety decision became part of the platform's longer-term value proposition rather than only a short-term cost.
...
**Source:** Bill Ready, CEO of Pinterest, public statements on platform safety decisions

**Analysis:**
This case shows:
1. **Values can support growth:** Ethical decisions can attract users seeking safety
2. **Differentiation through ethics:** Being "the safe platform" can become a competitive advantage
3. **Long-term thinking can pay:** Short-term stock pressure was followed by stronger Gen Z growth
4. **Leadership requires courage:** Right decisions aren't always popular decisions

**Islamic Parallel:**
The Prophet Muhammad (PBUH) consistently chose principle over expedience:
- Rejected offers of wealth and power in exchange for compromising the message
- Protected the vulnerable even when politically costly
- Built lasting trust through unwavering principles

The Quranic injunction applies: "O you who believe! Be persistently standing firm for God, witnesses in justice, and do not let the hatred of a people prevent you from being just." (Quran 5:8)

#### 2.1.4.2 Case Study: Redis to Valkey - The Cost of License Betrayal

Redis, an immensely popular open-source in-memory data store, maintained a three-clause BSD license for years while building a massive community of contributors and users. In March 2024, Redis Labs announced a license change to the proprietary Redis Source Available License (RSALv2) and Server Side Public License (SSPLv1), ending in practice Redis's open-source status.

The community's response was rapid and visible. Within weeks, the Linux Foundation announced Valkey, a community fork maintaining the original open-source license. Major technology companies including Amazon Web Services, Google, Microsoft, and Oracle publicly backed Valkey. The fork team established priorities that support ethical governance analysis in this thesis: preserving core processes, building neutral governance, keeping the community together, and "defaulting everything to open."

The contrast in governance philosophies was instructive. Under Redis Labs, features had been "rejected for non-technical reasons"—community-requested functionality denied because the company "did not want it." Project infrastructure was opaque, with builds, testing, and releases controlled exclusively by Redis employees. Valkey implemented the opposite approach: all meetings public, private meetings explicitly prohibited, branch protections to prevent accidents rather than police intentions, and predictable release cadences.

Most tellingly, Redis reversed course in May 2024, reopening the codebase under the GNU AGPL. However, reversal did not automatically restore the previous governance relationship. Valkey had established independent momentum, and public trust in Redis governance had been weakened. The lesson is that license changes and governance ruptures cannot always be undone simply by reverting the technical change. Trust, once damaged, usually requires more than policy reversal to rebuild.

**I-VSD Analysis:** This case illustrates multiple framework principles. Promise-Keeping is implicated when long-standing licensing expectations are changed after a community has contributed under a different understanding. Trust is weakened when community contributions become tied to governance choices that contributors experience as capture. Valkey's support suggests that more open and neutral governance can attract institutional backing in some contexts, but it should not be treated as proof that ethical alternatives always succeed.

#### 2.1.4.3 Case Study: Private Internet Access - Practicing What You Preach

Private Internet Access (PIA), a VPN service, provides a positive example of a company whose documented choices appear aligned with its stated privacy values. When Russia demanded that VPN providers comply with government monitoring policies, PIA refused and was subsequently banned in the country, accepting market exclusion rather than compromising user privacy.

More substantively, PIA's technical architecture reflects its privacy claims. External audits and legal subpoenas have verified the company's no-logging policy: when authorities demanded "everything they had," the result was nothing, because no logs exist to surrender. The company uses RAM disks for all operations, meaning that power loss or physical hardware seizure results in irrecoverable data loss—the privacy guarantee is architectural rather than merely policy-based.

This represents the difference between privacy theater and privacy engineering. Some services claim privacy while maintaining technical capabilities for surveillance. PIA's architecture is designed to make certain forms of logging or disclosure technically unavailable, not merely against policy.

**I-VSD Analysis:** This case illustrates Truthfulness and Trust through alignment between public privacy claims and technical architecture. It also shows that I-VSD-aligned decision-making may require accepting market limitations when market access conflicts with user protection. The case supports a bounded point: users and reviewers can place more justified trust in privacy claims when architecture, audits, and legal-test history make those claims inspectable.

#### 2.1.4.4 Case Study: Meta/Facebook - Fraud Monetization and Algorithmic Complicity

In contrast to the positive case studies above, Meta (Facebook) provides an instructive negative example: a company whose documented practices reveal systematic prioritization of revenue over user protection, extending to what internal documents describe as monetization of fraudulent activity.

Internal records from litigation and whistleblower disclosures reveal that fraudulent advertising generates approximately 10% of Meta's advertising revenue. Rather than treating this as a problem requiring aggressive intervention, the company's anti-fraud teams were reportedly blocked from taking any action that would cost more than 0.15% of revenue—in practice preventing meaningful fraud prevention. The mathematics are stark: any anti-fraud measure costing more than 0.15% was prohibited, while fraud generating 10% of revenue was tolerated.

More troubling still, reports indicate Meta charged premium rates for advertisements suspected of being fraudulent—a "scam tax" that converted fraud detection into additional revenue rather than user protection. The company profited more from identified scams than from legitimate advertisements, creating perverse incentives that directly conflict with user welfare.

The platform's algorithmic systems compound these issues. Machine learning optimization for engagement naturally identifies users vulnerable to fraudulent appeals—those who click on scam advertisements—and subsequently serves them more of the same content. The algorithm does not distinguish between engagement driven by genuine interest and engagement driven by exploitation of vulnerability. Users susceptible to fraud receive algorithmically amplified exposure to fraudulent content, not because anyone explicitly programmed this outcome, but because engagement optimization inherently exploits human psychology without regard for user welfare.

This case illustrates several I-VSD principles through violation rather than compliance. The deliberate tolerance of fraud for revenue contradicts the prohibition against cooperating in sin (Quran 5:2). The "scam tax" represents profit extracted from harm inflicted on users—a direct violation of the principle that business must not benefit from customer injury. The algorithmic amplification of vulnerability shows how technical systems can systematically violate Islamic principles even without explicit harmful intent: optimization for engagement metrics, when applied without ethical constraints, naturally evolves toward exploitation.

**I-VSD Analysis:** This case shows that I-VSD review requires more than avoiding directly harmful products; it requires examining the systemic incentives embedded in business models and technical architectures. Meta's advertising platform is not inherently forbidden—advertising itself is permissible—but the specific choices made to prioritize fraud revenue over user protection, to profit from identified scams, and to allow algorithmic amplification of vulnerability transform a permissible business into one that systematically harms users. I-VSD-aligned alternatives would need explicit fraud-prevention duties, revenue rules that do not reward harmful content more than legitimate content, and algorithmic safeguards against vulnerability exploitation.

### 2.2 Value-Sensitive Design as Background and Design-Sensitivity Reference

Value-Sensitive Design (VSD) is a Human-Computer Interaction approach that treats values as design concerns. Emerging in the 1990s through Batya Friedman and Peter Kahn at the University of Washington, it is useful here because it keeps attention on values during technical design. In this thesis, however, VSD remains only a background design-sensitivity reference; I-VSD's normative authority, boundaries, and evaluation questions come from selected Sunni Islamic ethical principles.

#### 2.2.1 Core Principles and Methodology

VSD is usually described through conceptual, empirical, and technical investigations: identifying stakeholders, values, and trade-offs; studying how people understand the technology and values at stake; and analyzing how technical choices support or undermine those values. These investigations are iterative, so empirical findings and technical constraints can reshape conceptual work.

For this thesis, the point is not to import the whole method, but to preserve the design lesson that values and technical architecture interact.

#### 2.2.2 VSD in Software Development Practice

VSD has been applied to software contexts such as privacy-enhancing technologies, accessible computing, electronic health records, and social media platforms. These examples show that explicit value attention can change software choices.

The Center for Humane Technology (humanetech.com) likewise warns that "promises of technology can end up distorted by misaligned incentives hidden throughout the development, deployment, and diffusion of a new technology." This observation motivates I-VSD as a provider-responsibility framework: provider incentives and lifecycle decisions need moral scrutiny, while selected Islamic commitments provide the governing standard.

#### 2.2.3 Limitations of VSD for Religious Contexts

Despite its contributions, VSD is limited when applied to religious communities because it generally treats values as emerging from stakeholder consultation and philosophical analysis. For Muslim providers and users, stakeholder preference cannot override divine command or scriptural prohibition.

VSD literature also emerges largely from Western academic contexts with implicit secular liberalism as the value baseline. It centers concepts such as autonomy and privacy, while concepts central to Islamic ethics, including God-consciousness, Modesty, and communal obligations, receive no systematic treatment. Existing VSD applications also rarely address Muslim technical concerns such as permissible business models, avoidance of interest-based transactions, gender-specific accessibility, prayer schedules, or lunar calendars.

This gap motivates Islamic Value-Sensitive Design (I-VSD) as a provider-responsibility framework: it uses VSD as a design-sensitivity reference while grounding value identification, limits, and evaluation questions in Islamic sources rather than secular stakeholder consensus alone.

#### 2.2.4 Related Value-Conscious Approaches in Software Development

I-VSD is part of a broader family of approaches that try to make values, rights, risks, or responsibilities visible during technology design. The comparison matters because I-VSD should not be presented as if it invented value-conscious software engineering by itself. Its contribution is more specific: it uses selected Sunni Islamic ethical principles as a normative specification layer for provider-mediated software, while borrowing from existing design and governance traditions only where they help structure stakeholder analysis, requirements translation, evaluation, or audit.

The following comparison positions I-VSD against adjacent approaches without treating those approaches as interchangeable.

| Approach | Normative anchor | Main strength | Limitation for this thesis | Use in I-VSD |
| --- | --- | --- | --- | --- |
| Standard Value-Sensitive Design | Human values identified through conceptual, empirical, and technical investigations. | Keeps values visible during design and links stakeholder analysis to technical choices. | It can leave the source and priority of values under-specified when stakeholder preferences conflict with religious obligations. | Provides design-sensitivity vocabulary, not I-VSD's moral authority. |
| VSD critiques and lived-value approaches | Critical reflection on which values are selected, whose values count, and how values appear in lived practice. | Warns against treating designer-selected values or abstract stakeholder preferences as neutral. | It does not by itself decide contested Islamic norms or software-provider obligations. | Strengthens reflexivity, positionality, and power-awareness in the thesis. |
| Capability Sensitive Design | Capability theory and attention to human diversity, dignity, and structural injustice. | Helps connect technology design to what people are actually able to be and do. | Its capability foundation is not identical to Islamic moral grounding and does not settle Islamic legal or ethical boundaries. | Helps examine exclusion, access, dignity, and capability loss in provider-mediated software. |
| Care-centered VSD | Care ethics, vulnerability, dependency, role responsibility, and relational practice. | Makes dependency and responsibility visible where users rely on technical systems or institutional actors. | Its original context is care robotics, so it cannot be generalized without adaptation. | Helps analyze relational obligations, support duties, moderation, maintenance, and vulnerable-user contexts. |
| Value-based Engineering and IEEE 7000 | A system-engineering process for translating values and ethical concerns into requirements, risks, and organizational controls. | Gives a stronger bridge from values to requirements, traceability, process ownership, and lifecycle review. | It is a secular engineering process and does not determine which Islamic values are binding. | Provides a useful model for later I-VSD formalization, traceability, and governance artifacts. |
| Responsible Research and Innovation | Anticipation, inclusion, reflexivity, and responsiveness in innovation governance. | Connects design choices to governance, public accountability, and revision over time. | It is broad innovation-governance vocabulary, not a provider-specific Islamic ethics framework. | Helps structure lifecycle review, stakeholder disagreement, and revision duties. |
| AI governance and algorithmic impact frameworks | Risk management, rights protection, documentation, oversight, impact assessment, and legal compliance. | Provide concrete audit language: risk registers, impact assessment, human oversight, documentation, incident response, and review intervals. | Compliance does not equal moral sufficiency, and legal instruments do not supply Islamic normative authority. | Supplies governance and audit vocabulary for future I-VSD evaluation and policy alignment. |
| DevGreenOps / DevSusOps | Environmental sustainability in software delivery and operations. | Shows that values can become engineering questions such as monitoring, minimalism, efficiency, and operational awareness. | Sustainability is only one value domain and does not address the full provider-responsibility scope of I-VSD. | Serves as an analogy for turning moral concerns into operational criteria. |
| I-VSD | Selected Sunni Islamic ethical principles applied to provider-mediated software responsibility. | Grounds values, limits, trade-off boundaries, and governance questions in a religiously specific normative framework. | This thesis does not claim full Islamic legal adjudication, empirical validation, or universal applicability. | Supplies the thesis's main design-science artifact: a provider-facing framework for ethical software reasoning. |

This comparison sharpens the thesis contribution. Standard VSD explains why values should be part of design work. VSD critiques show why value selection and stakeholder interpretation require caution. Capability Sensitive Design and care-centered VSD show how a design method can be strengthened by a more explicit normative theory. Value-based Engineering and IEEE 7000 show how value discussions can move toward requirements, controls, traceability, and organizational process. Responsible innovation and AI governance frameworks show how ethical design must remain reviewable over time.

I-VSD uses these approaches as comparison points and practical scaffolding, not as substitutes for Islamic moral grounding. In this thesis, Islamic ethics supplies the value source and boundary conditions; design and governance frameworks help express those commitments as provider questions, requirements, controls, evaluation criteria, and lifecycle duties. This means I-VSD is neither a simple overlay on VSD nor a replacement for engineering standards, public policy, or Islamic scholarship. It is a bounded normative-design framework whose claims must remain separated from empirical validation until stakeholder studies, audits, deployment evidence, and scholarly review are actually performed.

DevGreenOps remains a useful analogy for this bridge from value to practice. Joswig (2025) organizes sustainable software delivery around transparency, minimalism, efficiency, and awareness. Pereira et al. (2021) found that implementation choices can produce 75-fold differences in energy consumption. The lesson for I-VSD is not that environmental sustainability and Islamic software ethics are the same. The lesson is that ethical commitments become more useful when they can shape design questions, operational metrics, review practices, and constraints before harm is externalized.

### 2.3 Islamic Ethical Principles for Software Design

This section identifies the selected Sunni Islamic ethical principles used in the thesis and explains how they become design-relevant responsibilities for provider-mediated software solutions. It does not attempt to resolve every juristic question or replace scholarly consultation. Its role is to provide a source-anchored ethical basis that Chapter 3 operationalizes through the I-VSD framework.

#### 2.3.1 Core Islamic Ethical Principles Applicable to Software Development

This section identifies the Islamic ethical principles that function as the normative foundation for the I-VSD framework. The purpose is not to produce a complete manual of Islamic law, issue legal rulings, or resolve every scholarly disagreement. The purpose is narrower: to show how selected Sunni Islamic ethical principles can be translated into design-relevant responsibilities for provider-mediated software solutions.

The principles below are therefore treated as source-grounded design anchors. Quranic and Hadith references establish why the principle matters within the selected Islamic ethical scope. The software translations are thesis-level interpretations that will be developed into practical I-VSD heuristics in Chapter 3.

##### Role of the Principles in This Thesis

The selected principles serve four functions:

| Function | Role in the Thesis |
| --- | --- |
| Normative grounding | They explain why the framework does not rely only on market demand, stakeholder preference, or technical feasibility. |
| Design translation | They help convert broad moral concerns into questions a software provider can ask during design, implementation, governance, and evaluation. |
| Scope control | They keep the thesis focused on software-provider responsibility instead of expanding into all Islamic ethics, all business ethics, or full Islamic jurisprudence adjudication. |
| Case application | They provide the ethical vocabulary used later to analyze ISLAMU Event as an illustrative worked application. |

A principle does not automatically determine one technical answer. Rather, each principle helps identify relevant values, harms, stakeholder rights, design tradeoffs, and evidence requirements.

##### Operational Principle Map

| Principle | Source Anchors | Design-Relevant Meaning | Provider Design Questions | Main I-VSD Domains |
| --- | --- | --- | --- | --- |
| Trust | Quran 4:58; 8:27; 33:72 | Trust, stewardship, and responsibility for what has been entrusted. | What user data, infrastructure, content, commitments, or community trust has been placed under the provider's care? How is that trust protected? | Strategic, Technical, Governance, Operational |
| Truthfulness | Quran 9:119; 61:2-3; 2:42; Hadith reports on truthfulness in Bukhari and Muslim | Truthfulness in claims, communication, representation, and disclosure. | Are product claims, pricing, AI outputs, limitations, risks, and marketing messages truthful and understandable? | Strategic, Design, Evaluation |
| Justice | Quran 4:135; 16:90; 6:152; 5:8 | Justice, fairness, and avoidance of arbitrary or biased treatment. | Are access, moderation, ranking, pricing, support, and enforcement rules fair to affected stakeholders? | Design, Governance, Evaluation |
| Non-Harm | Hadith: "There should be neither harming nor reciprocating harm" reported in Ibn Majah and other collections | Prevention and reduction of foreseeable harm. | What privacy, security, financial, spiritual, social, or community harms could the system enable or intensify? | Technical, Operational, Evaluation |
| Rights of People | Bukhari 2449; Ibn Majah 2443; reports on unlawful taking of another person's wealth | Rights of people, including property, reputation, consent, dignity, and just treatment. | Whose rights are affected by this design, including users, maintainers, communities, contributors, and people represented in data or content? | Governance, Operational, Strategic |
| Avoiding Interest/Usury | Quran 2:275; 2:278-279; 3:130; Muslim 1598 | Avoidance of prohibited interest and exploitative financial arrangements. | Do funding, payment, credit, revenue, or dependency models create ethically compromised incentives or prohibited financial exposure? | Strategic, Governance |
| Avoiding Excessive Uncertainty | Muslim 1513 and broader commercial-ethics discussions on excessive uncertainty | Avoidance of excessive uncertainty, ambiguity, and hidden risk in transactions. | Are terms, pricing, renewal rules, capabilities, dependencies, risks, and limitations clear enough for responsible consent? | Strategic, Design, Governance |
| Avoiding Deception | Muslim 102 and reports condemning cheating and deception | Avoidance of cheating, hidden defects, and misrepresentation. | Does the system hide defects, manipulate choices, fabricate trust signals, obscure sponsorship, or mislead users about what is happening? | Design, Strategic, Evaluation |
| Promise-Keeping | Quran 5:1; 16:91; 17:34; Bukhari 33; Tirmidhi 1352 | Fulfilling covenants, promises, and commitments. | Are privacy promises, service expectations, portability guarantees, licensing commitments, support commitments, and lifecycle expectations honored over time? | Operational, Governance, Strategic |
| Excellence | Quran 16:90; Hadith of Jibril in Bukhari and Muslim; Muslim 1955 | Excellence, conscientiousness, and doing what is right with care. | Where does the provider need to go beyond minimum compliance because user safety, reliability, accessibility, or religious trust requires higher care? | Technical, Operational, Evaluation |
| Modesty | Hadith reports on modesty in Bukhari and Muslim; Ibn Majah 4182 | Modesty, restraint, and avoidance of shameless exposure or corrupting display. | Does the design unnecessarily expose users, normalize immodest content, reward attention-seeking behavior, or weaken moral restraint? | Design, Strategic |
| Avoiding Spying | Quran 49:12; Bukhari/Muslim reports against suspicion and spying; Bukhari 7042 | Avoidance of spying, intrusive surveillance, and unjustified observation. | Is the system collecting, inferring, tracking, profiling, or monitoring beyond legitimate need and informed expectation? | Technical, Governance, Evaluation |

##### From Principle to Design Heuristic

For this thesis, each principle becomes actionable only after it is translated into provider-facing questions and design constraints. The translation process follows the same pattern across the framework:

| Translation Step | Purpose |
| --- | --- |
| Identify the provider decision | Clarify which design, technical, business, governance, or evaluation decision is being made. |
| Identify affected stakeholders | Include direct users and also affected communities, maintainers, contributors, administrators, funders, and people represented by data or content. |
| Identify value tension | Clarify where values may conflict, such as openness versus safety, personalization versus privacy, revenue versus non-exploitation, or automation versus accountability. |
| Translate the principle into a heuristic | Convert the principle into a practical question, design rule, or review criterion. |
| Record the evidence level | Distinguish conceptual reasoning, design evidence, illustrative case application, and empirical evidence. |

This prevents the thesis from treating Islamic terminology as decoration. The principles are meant to shape practical design reasoning across strategic, design, technical, operational, governance, and evaluation domains.

##### Scope Caution

The Islamic source anchors in this section are sufficient for the thesis's framework-development purpose, but they are not a substitute for scholarly Islamic legal review. Where a decision concerns finance, religious content, public religious guidance, or contested jurisprudential matters, a software provider should seek qualified scholarly consultation. The I-VSD framework can structure the relevant design questions; it does not replace Islamic scholarship or empirical stakeholder research.

#### 2.3.2 Summary: From Islamic Ethical Principles to I-VSD Domains

The selected Islamic principles in the previous section are not used in this thesis as a general moral checklist detached from software design. They function as the normative foundation for the I-VSD framework developed in Chapter 3.

For this thesis, the practical movement is:

| Step | Question | Output |
| --- | --- | --- |
| 1. Principle selection | Which Islamic ethical principles are relevant to provider responsibility in software? | A bounded set of selected Sunni ethical principles |
| 2. Design interpretation | What kinds of provider decisions does each principle affect? | Design-relevant ethical concerns |
| 3. Domain mapping | Where do those concerns appear in the software lifecycle? | Strategic, design, technical, operational, governance, and evaluation domains |
| 4. Heuristic translation | What should a provider ask or avoid when making decisions? | Practical I-VSD heuristics |
| 5. Case application | How does the framework structure a concrete design case? | ISLAMU Event as an illustrative worked application |

The selected principles do not all play the same role. A principle can function as a first-order value, a second-order constraint on trade-offs, an interpretive heuristic, a governance rule, or a red-line prohibition. The same principle may occupy more than one role depending on the design context. This distinction is important because stakeholder preference can help interpret and prioritize design concerns, but it cannot by itself make a prohibited or deceptive design choice ethically acceptable within I-VSD.

| Principle | Main normative role in I-VSD | How the role affects software design |
| --- | --- | --- |
| Trust | First-order value and governance rule | Treat entrusted data, infrastructure, promises, and religious/community dependence as responsibilities that require assignment, documentation, and review. |
| Truthfulness | First-order value and red-line against misrepresentation | Product claims, prices, limits, automation disclosures, and interface messages must not depend on falsehood or concealment of material facts. |
| Justice | First-order value and second-order constraint | Access, enforcement, ranking, pricing, moderation, and appeal should be reviewed for arbitrary or unfair treatment, especially where affected users have less power. |
| Non-Harm | Second-order constraint and red-line against foreseeable serious harm | Providers should identify, prevent, mitigate, and review foreseeable harms rather than treating harm as an acceptable cost of growth or convenience. |
| Rights of People | Governance rule and second-order constraint | Design choices must account for consent, dignity, reputation, ownership, compensation, and the rights of affected people beyond direct users. |
| Avoiding Interest/Usury | Red-line prohibition where applicable and scholarly-review trigger | Funding, payment, credit, and monetization flows require special caution and may require qualified Islamic financial review. |
| Avoiding Excessive Uncertainty | Interpretive heuristic and constraint on consent | Pricing, terms, service limits, renewal rules, capability claims, and vendor dependencies should be clear enough for responsible commitment. |
| Avoiding Deception | Red-line prohibition and design heuristic | Persuasive design, onboarding, ranking, comparison, and marketing choices should not rely on hiding or distorting relevant facts. |
| Promise-Keeping | Governance rule and constraint on lifecycle change | Public promises, privacy commitments, licenses, pricing expectations, uptime claims, and deprecation plans should be tracked and reviewed before material change. |
| Excellence | First-order value and interpretive heuristic | Accessibility, reliability, maintainability, documentation, and support should be treated as ethical quality concerns within realistic capacity limits. |
| Modesty | Interpretive heuristic and governance-review trigger | Content defaults, recommendations, imagery, profile visibility, and community standards should fit the intended moral and cultural context. |
| Avoiding Spying | Red-line against unjustified surveillance and constraint on data practice | Tracking, profiling, logs, analytics, and secondary use require necessity, proportionality, disclosure, access restriction, and retention review. |

| Principle | Main Ethical Concern | Typical Software Translation | Primary I-VSD Domains |
| --- | --- | --- | --- |
| Trust | Trust and stewardship | Treat user data, code, infrastructure, religious content, and commitments as entrusted responsibilities | Strategic, Technical, Governance, Operational |
| Truthfulness | Truthfulness | Avoid deceptive claims, hidden limits, misleading interfaces, false marketing, and opaque AI outputs | Design, Strategic, Evaluation |
| Justice | Justice and fairness | Avoid unfair access, arbitrary enforcement, biased ranking, discriminatory defaults, and unequal treatment | Design, Governance, Evaluation |
| Non-Harm | Harm prevention | Identify and reduce foreseeable user, community, financial, spiritual, security, and privacy harms | Technical, Operational, Evaluation |
| Rights of People | Rights of people | Respect consent, ownership, reputation, dignity, compensation, and the rights of affected stakeholders | Governance, Operational, Strategic |
| Avoiding Interest/Usury | Avoiding prohibited interest and exploitative finance | Review funding, payment, revenue, and dependency models for ethically compromised incentives | Strategic, Governance |
| Avoiding Excessive Uncertainty | Avoiding excessive uncertainty | Make terms, pricing, limits, risks, capabilities, and dependencies clear enough for responsible consent | Design, Strategic, Governance |
| Avoiding Deception | Avoiding cheating and misrepresentation | Do not hide defects, manipulate comparisons, fabricate reviews, or disguise commercial motives | Design, Strategic, Evaluation |
| Promise-Keeping | Keeping promises | Preserve commitments around privacy, portability, support, licensing, uptime, pricing, and lifecycle expectations | Operational, Governance, Strategic |
| Excellence | Excellence and conscientiousness | Build beyond minimum compliance where safety, reliability, accessibility, and user trust require care | Technical, Operational, Evaluation |
| Modesty | Modesty and moral restraint | Avoid designs that normalize shameless exposure, unnecessary attention capture, or spiritually harmful display | Design, Strategic |
| Avoiding Spying | Avoiding spying and intrusive surveillance | Avoid unjustified tracking, profiling, covert observation, and collection beyond legitimate need | Technical, Governance, Evaluation |

This summary prepares the move from theory to framework. Chapter 3 translates these principles into a reusable I-VSD structure for provider-mediated software solutions, while Chapter 4 applies that structure to ISLAMU Event as one illustrative case rather than as full empirical validation. The role taxonomy also clarifies that the framework is not only a list of desirable values: it contains values to pursue, constraints to respect, heuristics to interpret, governance rules to document, and red lines that should not be traded away by convenience or stakeholder preference.
...
**Design Science Research:** Following the logic of Design Science Research, this thesis creates a framework artifact intended to structure ethical design reasoning. In DSR terms, I-VSD is closest to a construct/model/method artifact: it defines concepts, organizes relationships, and gives providers a repeatable way to reason from selected Islamic principles to design heuristics. The framework is assessed through internal coherence, traceability from principles to heuristics, and case-based application. This follows the DSR logic of artifact construction and evaluation associated with Hevner et al., Peffers et al., and Gregor and Hevner, but it remains initial design evidence rather than full empirical validation.
...
This limitation should not be confused with uselessness. A purely future-oriented thesis could describe what an ethical provider ought to do without showing whether the author was willing to let those commitments constrain an actual project. The self-applied case therefore answers a narrower methodological question: whether the framework can be translated into inspectable design choices in one concrete setting. It does not answer the stronger question of whether independent teams, users, scholars, or auditors would validate the same choices.
...
![figure evidance level ladder](../30-Resources/Thesis/figure_evidance-level-ladder.png)
...
The implementation evidence is therefore used as traceability evidence: it can show that ethical concerns influenced architecture, governance, data modeling, documentation, testing, accessibility, and operations. It cannot show that users experienced those choices as trustworthy, accessible, secure, or beneficial without later field evidence.
...
4. **Heuristic formulation:** Convert the mapped questions into practical heuristics that a software provider can use during architecture, interface design, data governance, content governance, communication, and business-model decisions.
   ...
   The accompanying `i-vsd` agentic skill operationalizes this derivation sequence as a practitioner-support workflow. It routes provider-mediated software questions into bounded actions such as context discovery, compliance-style review, architecture review, business-model review, AI/data review, guided discovery, implementation review, and moral-diff review. In methodological terms, the skill is not a second case study and not evidence that I-VSD has achieved stakeholder or operational validation. It is an agentic formalization artifact: it shows how the framework's principles, domains, stakeholder questions, evidence levels, report contracts, and scholarly-escalation boundaries can be translated into repeatable software-review procedures.
...
##### Agentic Implementation of the Derivation Protocol

The `i-vsd` skill is therefore part of the framework artifact produced by this methodology, not merely an example of the framework being mentioned in another repository. Its role is to convert the derivation protocol into an agent-readable procedure that can be installed or adapted inside a provider-mediated software repository. The skill remains software-solution agnostic because it does not assume one product type, programming language, deployment model, or AI host. Instead, it defines a portable workflow folder, a resource reading order, action-routing rules, report filenames, and claim-boundary requirements that a capable agent can follow when reviewing a concrete provider decision.

The implementation choices mirror the methodological chain of I-VSD:

| Methodological step | Agentic implementation choice | Boundary preserved |
| --- | --- | --- |
| Scope the decision | The skill first checks whether the request concerns provider-mediated software responsibility and refuses unrelated or authority-bound requests. | I-VSD is not used as a label for generic programming help, unrelated advice, personal religious guidance, fatwa requests, or certification claims. |
| Identify stakeholders and provider duties | The context gate requires product, repository, policy, operational, stakeholder, or user-provided evidence before deeper review. | The agent should not infer provider intent or stakeholder effects from a prompt alone when relevant evidence is missing. |
| Map principles and domains | The resource library keeps selected principles, the six domains, derivation rules, and domain heuristics available to any agent that can read the folder. | A review should not collapse I-VSD into one domain, such as UI or code, when strategic, operational, governance, or evaluation duties are also implicated. |
| Form heuristics and recommendations | The action router converts user intents into report types such as consultancy review, architecture review, AI/data review, implementation review, guided discovery, or moral-diff review. | The output remains design reasoning and implementation traceability rather than a claim that the product is Islamically certified or empirically successful. |
| Record evidence and tradeoffs | Report contracts require evidence reviewed, missing evidence, validation gaps, escalation needs, rejected alternatives, and claim boundaries. | Missing evidence must be named instead of filled by speculation, and stronger claims remain future validation. |
| Preserve review artifacts | Generated reports use a predictable `islamic-value-sensitive-design/i-vsd-*.md` namespace in the host repository or approved workspace. | I-VSD reasoning becomes auditable over time without pretending that a Markdown report is itself scholarly, stakeholder, or operational validation. |

This makes the skill a design-science implementation of the framework: it is a constructed artifact that embodies the framework's reasoning rules, evidence discipline, and refusal boundaries. Its portability claim is bounded. It can be added to provider-mediated software repositories where product, service, platform, data, infrastructure, governance, or operational decisions create continuing provider responsibility. It should not be claimed to apply universally to repositories with no such responsibility, and it should not be claimed to work with every AI system automatically. The agent using it must be able to load the resources, follow the scope rules, inspect relevant evidence, and write the required bounded reports.


![figure agentic derivation protocol](../30-Resources/Thesis/figure_agentic-derivation-protocol.png)

**Alt text/textual equivalent:** Diagram showing how I-VSD methodological steps are translated into the portable `i-vsd` agentic skill through scope checks, context discovery, resource mapping, routed reviews, evidence records, and persistent reports.

![figure i vsd disctinct from vsd](../30-Resources/Thesis/figure_i-vsd-disctinct-from-vsd.png)

**Alt text/textual equivalent:** Architectural diagram of the 6-stage I-VSD framework. It maps industry harms into a converged foundation of VSD design sensitivity and Islamic ethical boundaries. This convergence produces context-sensitive heuristics that guide a central provider responsibility lifecycle and ensure traceable implementation.
...
##### Conflict and Trade-off Rules

The framework expects value tensions rather than assuming that every principle always points toward the same design choice. A privacy-protective design may make abuse prevention harder; accessibility may require collecting preference data; fraud prevention may require some monitoring; and pricing clarity may conflict with rapidly changing infrastructure costs. I-VSD therefore treats conflict handling as part of the framework rather than as an afterthought.

The following rules guide how conflicts are handled in this thesis:

1. **Identify the kind of conflict.** The provider should distinguish value-versus-value conflicts, value-versus-business-objective conflicts, technical feasibility conflicts, stakeholder-disagreement conflicts, and cases requiring qualified Islamic or legal review.
2. **Separate non-negotiables from weighted trade-offs.** Deception, unjustified surveillance, deliberate serious harm, clear breach of promise, and clearly prohibited financial structures are not treated as ordinary trade-offs merely because they increase growth, convenience, or revenue.
3. **Use stakeholder evidence for interpretation, not unchecked moral authority.** Stakeholder feedback helps reveal lived effects, hidden harms, usability problems, and contested meanings, but stakeholder preference alone cannot override the selected Islamic ethical constraints used by I-VSD.
4. **Prefer the least harmful sufficient design.** Where several options can satisfy the service goal, the provider should prefer the option that meets the goal with less data collection, less manipulation, less exclusion, fewer broken expectations, and clearer accountability.
5. **Document justification and evidence level.** A trade-off should name the principle affected, the requirement or control chosen, the evidence currently available, the unresolved risk, and the kind of future validation needed before making stronger claims.
6. **Escalate contested or specialized questions.** Financial structures, religious content boundaries, dignity/modesty disputes, high-impact profiling, and cross-jurisdictional legal conflicts may require qualified scholarly, legal, practitioner, or stakeholder review beyond what this bachelor thesis can settle.

These rules do not make I-VSD a complete jurisprudential method or a mathematical optimizer. They make explicit how the thesis moves from principles to design reasoning while preserving the distinction between ethical argument, implementation traceability, and future validation.
...
![figure i vsd conceptual model](../30-Resources/Thesis/figure_i-vsd-conceptual-model.png)
...
![figure provider responsibility accross the lifecycle](../30-Resources/Thesis/figure_provider-responsibility-accross-the-lifecycle.png)
...
4. **Classify the normative role:** Mark whether the principle functions in the situation as a value to pursue, a constraint, an interpretive heuristic, a governance rule, a red-line prohibition, or a combination of these roles.
5. **Convert tensions into heuristics:** Turn the strongest value tensions into practical design heuristics, decision rules, or review questions.
6. **Separate trade-offs from non-negotiables:** Identify which choices may be balanced through justified trade-offs and which choices require rejection, escalation, or external review.
7. **Document tradeoffs and evidence level:** Mark whether each claim is conceptual, design-based, illustrative, empirical, or future work.
8. **Apply and review:** Use the matrix during case analysis or product development, then revisit it when new stakeholders, risks, or evidence appear.
...
##### Agentic Implementation Layer

The `i-vsd` skill adds an implementation layer to this structure. It expresses I-VSD as a portable agentic workflow that can be placed inside a provider-mediated software solution repository and used by any capable agent that can read Markdown resources, inspect local or provided evidence, respect refusal rules, and create persistent review reports. This makes the framework structurally reusable without tying it to one AI model, one IDE, one command-line tool, or one software stack.

The layer is agentic because it defines what an assisting agent should do before, during, and after a review. It is also bounded because the same structure tells the agent when not to operate. A request outside provider-mediated software responsibility should be refused rather than routed through I-VSD. A software-adjacent request that does not involve product responsibility should be narrowed rather than mislabeled. A request for halal, haram, makrooh, wajib, Sharia-compliance, or product-certification judgement should be escalated to qualified scholarly authority rather than answered by the skill.

![figure scope gate and refusal logic](../30-Resources/Thesis/figure_scope-gate-and-refusal-logic.png)

**Alt text/textual equivalent:** Flowchart showing that the `i-vsd` skill first checks whether a request concerns provider-mediated software responsibility, then refuses, narrows, escalates, or routes the request into a bounded I-VSD review.

| Structural feature | Skill implementation | Framework function |
| --- | --- | --- |
| Portable artifact | A self-contained skill entrypoint and resource library can be copied or adapted into a host repository. | Makes I-VSD available across provider-mediated software solution types without making the thesis dependent on ISLAMU Event. |
| Action routing | User requests are mapped to bounded actions such as compliance check, consultancy report, architecture review, AI/data review, implementation-code review, incident postmortem, guided discovery, and moral-diff review. | Converts the six-domain framework into repeatable practitioner workflows. |
| Context discovery | The agent inventories repository docs, policies, plans, code, tests, operational evidence, stakeholder evidence, and user-provided paths before writing findings. | Prevents ethical analysis from being based only on a prompt, diff, or isolated artifact. |
| Report persistence | Reviews are written or updated as `i-vsd-*.md` files under an `islamic-value-sensitive-design/` namespace. | Creates inspectable traceability from scope, evidence, findings, recommendations, validation gaps, and escalation needs. |
| Evidence ladder | Reports distinguish design reasoning, implementation traceability, stakeholder validation, operational validation, and theological or scholarly validation. | Prevents overclaiming and keeps validation categories separate. |
| Refusal and escalation | The skill refuses unrelated use, narrows adjacent use, and escalates religious-legal or high-stakes matters. | Treats non-operation outside scope as a moral safeguard rather than a technical limitation. |

![figure agentic implementation layer](../30-Resources/Thesis/figure_agentic-implementation-layer.png)

**Alt text/textual equivalent:** Layered diagram showing how the `i-vsd` skill can be placed inside a provider-mediated software repository, read by capable agents, and used to produce bounded I-VSD review reports while preserving refusal and escalation boundaries.

This implementation layer does not change the framework into an automated moral judge. It makes the framework operationally inspectable: an agent can help a provider produce scoped reports, document evidence gaps, and surface tradeoffs, but it cannot certify the product, replace scholarly consultation, or prove stakeholder and operational outcomes.

##### Formalization-Ready Traceability Layer

The framework can be made more formal without pretending that moral judgement is reducible to a calculation. In this thesis, formalization means a traceable design proposal: selected principles are translated into requirements, constraints, metrics, controls, and review questions so that later evaluation can inspect the reasoning chain.

The `i-vsd` agentic skill is an early implementation of this traceability layer. Its action routing, context-discovery gate, report templates, evidence-level categories, compliance-style findings, and scholarly-consultation boundaries instantiate the same structure in a reusable review workflow. This supports the framework's formalization potential across provider-mediated software solutions, including hosted platforms, open-source or self-hostable systems, APIs, AI-enabled features, and internal tools, while preserving the thesis boundary that traceability is not certification, fatwa, or empirical proof of ethical outcomes.

The formalization pipeline is:

1. **Normative sources:** identify the selected Islamic source basis and the principle being used.
2. **Value taxonomy:** state whether the principle is functioning as a value, constraint, heuristic, governance rule, or red-line prohibition.
3. **Stakeholder mapping:** identify who can be helped, harmed, excluded, surveilled, misled, or burdened by the design decision.
4. **Conflict classification:** separate ordinary value tensions from non-negotiable prohibitions or cases requiring external scholarly review.
5. **Requirement or constraint:** translate the principle into a provider-facing design obligation, limit, or review question.
6. **Metric or evidence object:** specify what could be inspected, measured, documented, or tested without claiming that the metric exhausts the moral principle.
7. **Control or design instantiation:** name the interface, architectural, policy, governance, or operational control that expresses the requirement.
8. **Evaluation and governance review:** record the evidence level, unresolved uncertainty, escalation path, and revision trigger.

The following mini-matrix illustrates the traceability artifact that later work can expand:

| Principle | Normative role | Requirement or constraint | Metric or evidence object | Control or design instantiation | Claim status |
| --- | --- | --- | --- | --- | --- |
| Avoiding spying | Red-line prohibition and governance rule where data collection is unnecessary or concealed | Collect only data that is necessary, disclosed, proportionate, and tied to the stated service purpose. | Data inventory, retention schedule, consent record, access log, privacy review, and incident history. | Data minimization, short retention defaults, access controls, audit logs, explicit disclosure, and periodic privacy review. | Current design proposal requiring future operational validation. |
| Truthfulness | Constraint and interpretive heuristic | Product claims, prices, limitations, and interface labels must match actual system behavior. | Marketing-interface comparison, pricing-change log, support-ticket patterns, and user comprehension tests. | Claim review before release, clear pricing screens, change notices, and escalation for misleading copy. | Current design proposal requiring stakeholder and operational validation. |
| Justice | Value, constraint, and evaluation rule | Access, moderation, ranking, or automated decisions should not create unjustified disparate burdens across stakeholder groups. | Disaggregated error rates, appeal outcomes, accessibility checks, and fairness diagnostics where relevant. | Bias review, appeal process, accessibility remediation, human review for high-impact decisions, and documented exception handling. | Optional formalization pattern when relevant data and normative justification are available. |

Some future extensions can use more formal methods, but only where the method matches the ethical question. Multi-criteria decision analysis could represent a design option as `U(d)=sum w_v u_v(d)-lambda R(d)`, where `w_v` are justified value weights, `u_v(d)` are value-specific utility estimates, and `R(d)` represents risk or rights-violation penalties. This is an optional comparison aid, not a moral proof; the weights require justification, sensitivity analysis, and review of whether any red-line constraint makes the option unacceptable regardless of score.

Fairness metrics such as equality of opportunity, equalized odds, individual fairness, or counterfactual fairness may help evaluate specific algorithmic subproblems, but they should not be used as a general substitute for Islamic ethical reasoning. Differential privacy, deontic logic, model checking, runtime enforcement, STPA, datasheets, and traceability matrices are likewise formalization options: they can strengthen documentation, control design, and review discipline, but they do not certify that the whole system is Islamically ethical.

For this thesis, the important point is not that I-VSD has already been mathematically formalized. The contribution is that the framework is formalization-ready: it defines the path from selected normative sources to design requirements and shows where future empirical, operational, and scholarly validation would be needed.
...
The `i-vsd` agentic skill extends this heuristic layer into an action-oriented review workflow. Instead of leaving heuristics as static lists, it uses context discovery, action routing, evidence inventories, claim-boundary language, and report templates to help a provider apply the same principles across business models, architecture, UX, data governance, AI behavior, moderation, marketing, operations, governance, and implementation changes. This makes the heuristics more practically usable while preserving their methodological status as design reasoning and implementation traceability rather than certification or proof.

#### Heuristics as Routed Action Families

In the agentic implementation, a heuristic is not only a sentence in a checklist. It becomes part of a routed action family that determines what evidence the agent should inspect, what report should be produced, which principles and domains should be reviewed, and what claim boundary must be stated. This is the main difference between a static heuristic appendix and the `i-vsd` skill as a thesis artifact: the skill gives future agents a procedure for choosing the appropriate review mode and recording the result in a durable report.

| Action family | Examples of routed actions | Thesis function | Boundary |
| --- | --- | --- | --- |
| Discovery and orientation | Guided discovery, strategy review, consultancy report, project-case review. | Turn low-context projects, missions, or product ideas into scoped I-VSD questions before recommendations are made. | Lack of context becomes an interview and missing-evidence record, not an excuse to invent facts. |
| Domain-specific review | Business-model, architecture, design/UX, AI/data, marketing, moderation, governance, operations, and legal-compliance reviews. | Apply the six-domain framework to concrete provider decisions while keeping detailed domain checklists in the artifact. | A review may identify concerns and escalation needs, but it does not certify the domain as ethical or Sharia-compliant. |
| Implementation review | Technical review, implementation-code review, and moral-diff review. | Connect principles to repository evidence such as code, documentation, configuration, tests, commits, and outgoing changesets. | Passing a review would support implementation traceability only; it would not prove security, accessibility, privacy, or user trust. |
| Incident and anti-pattern review | Incident postmortem, anti-pattern scan, and compliance-style check. | Identify deception, surveillance, lock-in, harmful automation, broken promises, support failure, or repair duties after risk appears. | Findings remain bounded by the reviewed evidence and should mark unresolved stakeholder, operational, legal, or scholarly questions. |

![figure routed action families](../30-Resources/Thesis/figure_routed-action-families.png)

**Alt text/textual equivalent:** Hub-and-spoke diagram showing how I-VSD heuristics become routed agentic review actions across discovery, domain review, implementation review, and incident or anti-pattern review.

This routed structure also makes refusal a heuristic safeguard. If a user asks the agent for unrelated advice, generic programming help, personal religious guidance, or a religious-legal ruling, the correct I-VSD action is not to force the request into a report. The framework-preserving action is to refuse or narrow the request and explain that I-VSD only covers provider-mediated software responsibility.

![figure moral diff review as implementation traceability](../30-Resources/Thesis/figure_moral-diff-review-as-implementation-traceability.png)

**Alt text/textual equivalent:** Workflow diagram showing how an outgoing software changeset can be reviewed through I-VSD lenses before pull request, push, or CI handoff, producing bounded findings rather than certification.

The external skill resources map onto the existing heuristic child sections rather than replacing them. This preserves the chapter's role as an academic framework description while allowing the agentic workflow to reuse the same domains as review actions:

| Thesis heuristic section | Matching `i-vsd` resource focus | Agentic review use | Claim boundary |
| --- | --- | --- | --- |
| Architecture | Architecture, technical decision, and implementation-review heuristics | Review lock-in, self-hosting, security, dependencies, continuity, tenant boundaries, and exit paths. | Supports design and implementation traceability; it does not prove security, resilience, or trust. |
| User interface and experience | UX/defaults and design-decision heuristics | Review dark patterns, pricing visibility, consent friction, protective defaults, accessibility, localization, and cultural fit. | Supports interface critique; it does not establish user experience without user evidence. |
| Data governance | Data-governance and AI/data review heuristics | Review collection purpose, sharing, retention, intrusive signals, access controls, export, deletion, and incident evidence. | Supports privacy-by-design reasoning; it does not prove privacy outcomes without audits or operational records. |
| Content moderation | Moderation and governance-review heuristics | Review rules, harm priority, appeals, consistency, ranking/monetization effects, and escalation needs. | Supports moderation design review; it does not prove fair enforcement or safety. |
| AI and algorithmic systems | AI, algorithmic, evidence-level, and source-integrity heuristics | Review labels, uncertainty, human escalation, bias, source separation, recommendation autonomy, and model-risk evidence. | Supports AI governance reasoning; it cannot validate religious, legal, medical, financial, or high-impact outputs. |
| Marketing and communication | Marketing, communication, and report-template heuristics | Review public claims, comparisons, claim-evidence registers, opt-in communication, trust repair, and manipulative persuasion risks. | Supports truthful-claim review; it does not prove market trust or user belief. |
| Business model | Business-model, strategic, and consultancy-review heuristics | Review revenue pressure, pricing clarity, sponsorship, switching costs, stewardship, success metrics, and finance-related escalation. | Supports business-model moral risk mapping; riba, contracts, and investment questions still require qualified scholarly review. |
...
- **Implementation Directions:**
  ...
  - When no existing format can represent the required function responsibly, document the technical reason for the exception, publish schemas or conversion guidance where possible, and revisit the decision when standards emerge.
...
- **Implementation Directions:**
  ...
  - Design as though source code, internal behavior, and deployment details may eventually be inspected by outsiders.
  - Treat CI/CD, developer tools, package publishing, secrets, and dependency-update paths as security-critical parts of the architecture, not as neutral plumbing.
  - Link security requirements to code, tests, and known-issue records so that gaps remain visible instead of being hidden behind general claims of best practice.

**Heuristic: Match Assurance to Sector Risk**
- **Islamic Principle:** Non-Harm, Trust, Excellence
- **Provider Question:** Does the sector's risk profile require stronger review, disclosure discipline, or development controls than a low-risk application would require?
- **Implementation Directions:**
  - Treat health, finance, legal, safety-critical, and high-stakes community systems as requiring stricter engineering review than informal or low-impact tools.
  - Make security-disclosure and openness decisions according to threat model, regulatory expectations, and user harm, not ideology alone.
  - Avoid presenting secrecy itself as adequate security; when code, infrastructure, or operational details must remain restricted, pair that restriction with responsible review, logging, testing, and accountability.
  - Require human review, testing, and traceability before AI-generated, AI-assisted, or rapidly improvised code affects sensitive data, payments, safety, legal exposure, or core community trust.
  - Treat unsupported AI-development quality statistics as prompts for review rather than as evidence until their methodology and source are verified.
...
**Heuristic: Separate Operational Necessity from Optional Contact**
- **Islamic Principle:** Trust, Truthfulness, avoiding Spying
- **Provider Question:** Is the provider using contact information only for the user-requested service, or has necessary contact data been converted into marketing or third-party access?
- **Implementation Directions:**
  - Distinguish necessary operational messages, such as authentication, receipts, safety notices, and account confirmations, from promotional communication.
  - Ask for explicit opt-in before sharing attendee contact details with organizers, sponsors, partners, or marketing tools.
  - Store consent scope, recipient, event or organization context, timestamp, and withdrawal status where contact-sharing consent is used.
  - Explain the limits of revocation when data has already been exported to an organizer or another controller, and require downstream unsubscribe or deletion paths where feasible.
...
- **Implementation Directions:**
  ...
  - Distinguish compliance-supporting architecture from verified legal compliance, audit reports, certification, or operational maturity.
  - Avoid phrases that create the impression of certification when the evidence only supports "designed to support," "readiness-oriented," or "compatible with audited environments" claims.
...
- **Implementation Directions:**
  ...
  - Do not frame an ordinary paid purchase as charity, loyalty, or moral support unless the financial relationship is actually donation-like and clearly explained.
  - Separate operational notices from promotional communication.
  - Do not treat an email address received through signup, purchase, registration, authentication, or support as permission for marketing or organizer outreach.
  - Make refusal, withdrawal, and preference changes as clear as the initial consent request.
...
- **Implementation Directions:**
  ...
  - When criticizing another provider, use direct support, disclosure, or escalation channels first where safe and plausible, before reputational public criticism.
  - Preserve public warning, whistleblowing, legal complaint, and community-alert paths when direct channels fail, urgent harm exists, or users need timely protection.
  - Do not use terminology that makes normal user autonomy, alternative distribution, portability, or self-hosting sound illegitimate unless the risk claim is specific and evidence-bounded.
...
- **Implementation Directions:**
  ...
  - Review whether monthly-versus-annual pricing reflects real cost, churn, and planning differences or mainly penalizes users who cannot pay a large amount upfront.
...
- **Implementation Directions:**
  ...
  - Separate paid product value from donation or supporter language; if a subscription primarily purchases access, features, hosting, or support, describe it as commerce rather than emotional charity.
...
**Heuristic: Avoid Engineered Service Dependence**
- **Islamic Principle:** Justice, Promise-Keeping, Trust, avoiding Deception
- **Provider Question:** Does the product, contract, or maintenance model intentionally make the client dependent on the provider for ordinary control, correction, or modification so that additional fees can be extracted after commitment?
- **Implementation Directions:**
  - Define deliverables, acceptance criteria, maintenance obligations, and change-request boundaries before commitment.
  - Avoid designing avoidable lock-in or unnecessary provider-only modification paths into custom software.
  - Distinguish legitimate paid change requests from defects, non-delivery, unclear scope, or intentionally fragile design.
  - Provide documentation, handover, export, or reasonable self-service paths where client independence is part of the expected value.
...
- **Implementation Directions:**
  ...
  - Evaluate acquisition, investor, or ownership-transfer scenarios before users become dependent on the service.
...
![figure case study boundary](../30-Resources/Thesis/figure_case-study-boundary.png)
...
**Source:** Muslim Charities Forum (2025). "The Landscape of Debanking within Muslim Charities and its Impact on Charitable Activities." https://www.muslimcharitiesforum.org.uk/resources/
...
The case study is therefore not included merely because the author is building a related product. Its thesis function is to test the seriousness of the framework against actual design decisions: if the framework is persuasive, it should be possible to see where it changes priorities, constrains convenience, or makes tradeoffs explicit. This gives the reader more than an abstract promise, while still requiring caution about self-application and limited evidence.
...
**Core Problem Being Solved:** For decades, faith-based organizations have relied on fragmented methods,  word of mouth, paper posters, WhatsApp blasts, or centralized commercial platforms to facilitate gatherings. ISLAMU Event is designed to respond to the limitations of these methods by providing a purpose-built alternative that respects liturgical time (events linked to prayer times that change daily), community trust through verification labels, reporting paths, and governance controls intended to reduce fraud and misinformation risks, and data ethics (protecting community data from surveillance capitalism and third-party exploitation).
...
**Traceability framing:** The relevant provider responsibility is to reduce dependence on opaque or extractive intermediaries while preserving community ownership, truthful defaults, and portability. The current evidence level is design intention and implementation direction; real federation reliability, moderation effectiveness, fraud reduction, and community trust require future deployment, stakeholder feedback, audits, and operational evidence.

![figure islamu event ecosystem](../30-Resources/Thesis/figure_islamu-event-ecosystem.png)
...
**Provider responsibility / evidence level:** The provider responsibility in this comparison is truthfulness toward users and organizers: alternatives should be described accurately, ISLAMU Event's current evidence should be distinguished from its design direction, and Islamic framing should not be used as a shortcut for claiming superiority. This section therefore supports a decision-support and implementation-traceability claim, not a claim that ISLAMU Event is ethically or operationally superior to Mobilizon.
...
| Federation and portability | Providers should reduce unjust lock-in and make exit, interoperability, and community autonomy credible. | Event currently supports portability as a design direction through self-hosting, tenant autonomy, and documented federation groundwork, especially ATProto/PDS-oriented identity, event-record, OAuth-scope, and outbox/synchronization concepts where implemented. Strategically, this is intended to reduce the chicken-and-egg problem of isolated event platforms: organizers should not need to republish events manually across many providers if shared records can be read by multiple aligned applications. | Current evidence supports self-hosting and federation groundwork, not mature public federation. Federation policy, instance boundaries, sync behavior, moderation controls, identity handling, and interoperability testing remain ethical design concerns. | Federation increases moderation, spam, identity, compatibility, and governance complexity; the case illustrates roadmap-bound interoperability work, not mature public federation or easy/safe self-hosting. |
...
![figure high level technical architecture](../30-Resources/Thesis/figure_high-level-technical-architecture.png)
...
| Federation and portability | Providers should reduce unjust lock-in and make exit, interoperability, and community autonomy credible. | The current evidence supports federation groundwork, especially ATProto/PDS-oriented authentication, records, and outbound sync/outbox concepts. The intended design direction is that identity and selected event records can become less dependent on a single Event provider when users or communities operate through portable PDS-based infrastructure. It should not be described as finished ActivityPub federation, mature public ATProto integration, or a completed public federation server unless later evidence verifies that behavior. | Federation remains relevant as a portability and anti-lock-in design direction, with partial implementation evidence and a clear roadmap boundary. Protocol-oriented portability can reduce API gatekeeping, but only if identity resolution, OAuth scopes, record schemas, moderation, and operator documentation are implemented and tested. | Federation increases moderation, spam, identity, compatibility, and governance complexity; implementation groundwork does not prove safe or easy federation. |
...
**Provider responsibility:** The provider is responsible for making pricing, cancellation, availability, and paid-option flows understandable rather than using interface pressure to extract consent, payment, or attention.

**Evidence level:** This table records UX requirements and design-review criteria. It is not evidence that every future flow has been usability-tested or that dark patterns cannot reappear without continued review.
...
**Evidence level:** These are design-target features and community-benefit hypotheses. Their value would need user feedback, consent review, moderation evidence, and operational follow-up before being treated as achieved outcomes.
...
**Provider responsibility:** The provider is responsible for making revenue dependencies, sponsor influence, fee structures, and governance boundaries visible enough to be reviewed before they shape user choices or community access.

**Evidence level:** This is an ethical screening model for revenue design. It is not evidence that future funding will remain sustainable, free from pressure, or immune to hidden influence without financial review, governance practice, and operational transparency.
...
**Evidence level:** The open-source model is a governance and portability design direction. It remains dependent on documentation quality, maintainer capacity, operator behavior, and community adoption before stronger claims about freedom or sustainability can be made.
...
This section closes the `4.2` application branch. It synthesizes the strategic, technical, user-experience, and business-model application work developed in 4.2.3, 4.2.4, 4.2.5, and 4.2.6. The later summary in 4.4.10 has a different role: it summarizes concrete technical and architectural choices from the `4.4` branch.

![figure treacability map islamu event](../30-Resources/Thesis/figure_treacability-map-islamu-event.png)
...
The row-level evidence remains in the detailed branch sections rather than being repeated here. Governance, moderation, verification, and scope boundaries are developed mainly in 4.2.3; stack, tenant, privacy, federation, client-choice, and accessibility architecture are developed mainly in 4.2.4; pricing, dark-pattern, post-event, accessibility, and localization UX requirements are developed in 4.2.5; and fee posture, sustainability, and anti-enshittification reasoning are developed in 4.2.6.

##### Case-Testbed Evaluation Matrix

The same case can also function as a future evaluation testbed. The purpose of the matrix below is not to claim that ISLAMU Event has already validated I-VSD. It identifies where a later reviewer could inspect the chain from principle to provider responsibility, design requirement, implementation evidence, and future audit evidence.

| Case decision | Principle and provider responsibility | Requirement or control | Current thesis evidence | Future metric or audit evidence needed | Limitation |
| --- | --- | --- | --- | --- | --- |
| Privacy-first data architecture | Trust, Non-Harm, and avoiding Spying require the provider to minimize entrusted data and prevent unnecessary surveillance. | Data minimization, scoped consent, tenant isolation, export/delete paths, BFF token boundary, retention review, and access control. | Architecture and implementation-traceability discussion in the technical and privacy sections. | Data inventory, retention audit, access-log review, privacy/security audit, incident history, and user comprehension testing. | Current evidence shows design reasoning, not operational privacy outcomes or user trust. |
| Transparent pricing and non-manipulative UI | Truthfulness and avoiding Deception require choices, prices, limitations, and development status to be understandable before commitment. | Clear fee breakdowns, neutral choice language, no preselected upsells, visible cancellation, and development-state notices. | UX and business-model reasoning, plus traceability to anti-dark-pattern requirements. | User comprehension tests, dark-pattern review checklist, pricing-change audit, support-ticket analysis, and cancellation-flow testing. | Current evidence does not prove that users understand the interface or experience it as trustworthy. |
| Accessibility and localization | Justice, Excellence, and Non-Harm require avoidable barriers to be treated as ethical failures, not optional polish. | Semantic structure, keyboard and screen-reader support, language metadata, RTL/direction handling, translation review, and accessible component conventions. | Accessibility-oriented implementation traceability and UI requirements. | WCAG-oriented audit, assistive-technology testing, browser accessibility automation, translation review, affected-user feedback, and maintenance review. | Current evidence is not certification of accessibility or localization quality. |
| Portability and self-hosting | Promise-Keeping, Trust, and Rights of People require that communities not be trapped by one provider. | Self-hosting path, export/import support, tenant switching, custom API URL support, federation groundwork, and documented instance governance. | Design and implementation evidence for self-hosting, tenant autonomy, and federation direction. | Install/redeployment tests, export-import tests, interoperability review, self-hosting usability study, governance review, and failure-mode testing. | Public interoperability and community adoption remain future evaluation questions. |
| Future AI assistance boundaries | Truthfulness, Justice, Non-Harm, and Trust require AI support to remain disclosed, constrained, reviewable, and reversible. | Human review for high-impact actions, scoped permissions, audit logs, rollback paths, bias review, and disclosure of limitations. | Future-feature governance reasoning in the AI integration section. | Model/vendor review, bias and hallucination testing, permission audit, red-team scenarios, incident logs, human-review workflow tests, and post-deployment monitoring. | This is a future validation protocol, not evidence that AI features are safe or deployed. |

This testbed framing makes the case more reproducible: another researcher could inspect the same decision chains, gather the missing evidence, and challenge whether the requirements actually express the selected principles. It also preserves the main limitation of this chapter. Because the case is a founder-led self-application, it can demonstrate structured reasoning and design traceability, but independent practitioner review, stakeholder research, operational records, and scholarly review are still needed before making stronger claims.
...
**Provider responsibility:** The provider is responsible for making its governance form, accountability routes, and financial incentives visible enough that users, partners, donors, and community stakeholders can understand who the service is designed to serve.

**Evidence level:** The ASBL form is governance-traceability evidence for the case design. It is not evidence that the organization will automatically remain transparent, sustainable, or ethically governed without board practice, financial reporting, stakeholder review, and operational accountability.

**Comparative governance example:** A 2026 JetBrains interview with Andrew Kelley describes the Zig Software Foundation board setting Kelley's annual salary at $154,000 by reference to the median senior software engineer salary in New York City at the time the nonprofit was formed. This example is useful as a comparison point, not because Zig is an I-VSD case or an Islamic ethics case, but because it shows that nonprofit stewardship need not mean symbolic underpayment. A mission-oriented organization can still treat skilled labor as worthy of fair, substantial compensation when compensation is bounded, board-accountable, and explainable to supporters.

**Boundary:** Non-profit structure does not by itself create transparency, sustainability, user alignment, or ethical practice. It introduces its own risks, including donor dependence, capacity limits, governance burden, ambiguous accountability, and slower execution. Public-interest branding can even make later inconsistency more damaging, because users may rely on the organization's stated mission when interpreting privacy, data, funding, or product-policy changes. Those risks must remain visible in later evaluation.
...
One concern is post-dependence extraction. If a mission-oriented service first earns trust, gathers users, and becomes operationally important, a later sale or investor-led ownership change can alter the optimization target. The same product that was originally designed around community benefit may then be evaluated for unused pricing power, reduced support cost, data leverage, or dependency capture. Avoiding conventional capital investors in this case is therefore not only about early funding; it is also about reducing the probability that future ownership pressure turns accumulated trust into an extraction asset.
...
Fund stewardship also includes how an organization pays the people doing essential work. The Zig Software Foundation interview offers a useful external example: the issue is not whether a nonprofit worker receives the smallest possible salary, but whether compensation is transparently set, proportionate to the role and labor market, and compatible with the organization's mission and runway. For ISLAMU, this suggests that future funding explanations should avoid both extremes: extracting excessive personal benefit from community funds and romanticizing unpaid or underpaid labor in a way that makes the project unsustainable.

**Provider responsibility:** The provider is responsible for choosing funding channels that do not quietly transfer control over user data, moderation, pricing, access, or long-term mission to actors whose incentives are hidden from the community.

**Evidence level:** This is a case-specific funding-governance rationale. It does not prove that donation, grant, sponsorship, or volunteer-based funding will be sufficient, sustainable, or free from pressure without financial review, public reporting, and operational experience.
...
**Provider responsibility / evidence level:** The provider responsibility in this section is to make open-source and self-hosting claims practically inspectable rather than symbolic: licensing, buildability, deployment documentation, export paths, sponsor influence, and hosted-service boundaries should be visible enough for users and operators to evaluate. The current evidence supports a governance and design-direction claim about reducing dependency; it does not prove that users already experience practical freedom, sustainability, or independence in operation.
...
This also affects vocabulary. If community hosting, alternative clients, direct installation, export, or interoperability are described primarily as dangerous, unofficial, or abnormal, the language itself can weaken user freedom before any technical restriction is applied. ISLAMU should communicate security risks honestly without adopting framing that treats provider-controlled distribution as morally or technically default in all cases.

ATProto-oriented design extends this concern from exportability after leaving a provider to protocol-level portability before dependency becomes entrenched. If identity, social graph, and selected event records can be anchored in a user-controlled or community-controlled PDS, then an event platform can become less like a closed destination and more like one application rendering and contributing to a shared user-controlled data layer. This is why the thesis treats ATProto as relevant to anti-lock-in and user sovereignty. The current claim must remain bounded: ISLAMU Event can point to ATProto/PDS-oriented groundwork and design direction, not to a completed mature public federation ecosystem.

Contributor governance is another part of open-source user freedom. A project that receives community contributions must be honest about whether contributors keep copyright, grant broad relicensing rights through a CLA, assign copyright, or contribute only under the existing public license. I-VSD does not require one universal answer and does not treat dual licensing as automatically unethical. The ethical issue is whether contributors and users can understand the governance bargain before they invest labor, trust, and dependency. A project that claims community stewardship while quietly preserving a later path to close or relicense community work risks undermining Promise-Keeping and Trust, even if a particular legal structure is formally valid.
...
- **Provider responsibility:** Structure funding, licensing, governance, and documentation so the provider has fewer incentives and fewer technical paths to trap users later.
...
The business model should also resist pricing designs that turn user cash-flow constraints into leverage. Annual discounts can be legitimate when they reflect lower churn risk, simpler billing, or predictable capacity planning. The ethical concern arises when the monthly option is priced mainly as a penalty, making users with less upfront capital pay substantially more for the same service because they cannot commit for a full year. I-VSD does not require a single pricing formula, but it asks whether the spread between monthly and annual plans reflects real cost and risk or functions primarily as behavioral coercion.

Ownership change is another enshittification pathway. A product that is not yet financially optimized may look attractive to buyers who can increase short-term returns by raising prices, cutting support, reducing free/community features, or weakening exit paths after dependence has formed. ISLAMU's anti-enshittification posture therefore treats acquisition, sponsor influence, and future governance-transfer rules as part of business-model design rather than as events outside ethical review.

![figure islamu event business model](../30-Resources/Thesis/figure_islamu-event-business-model.png)

**Reference Sources:**
- Cory Doctorow's enshittification concept
- Platform degradation examples discussed in Section 2.1

**Evidence level:** This section provides design-rationale and governance-traceability evidence. It does not establish that the chosen business model will remain sustainable, resist every degradation pressure, or maintain user trust without future operational and community evidence.
...
**Provider responsibility:** The provider is responsible for documenting partner-selection criteria, influence limits, review triggers, and escalation routes so that partnerships do not silently reshape moderation, ranking, data access, funding dependence, or public mission.

**Evidence level:** This section defines a screening obligation and review pattern. It is not evidence that every future partnership decision will be correct, that all partner risks can be known in advance, or that contested political and legal claims have been settled by the thesis.
...
**Provider responsibility / evidence level:** The provider responsibility in this section is to choose and explain infrastructure in a way that operators can inspect, maintain, and replace, rather than treating open-source labels as automatic ethical proof. The current evidence supports an architectural-reasoning and implementation-traceability claim about reduced lock-in; it does not prove operational reliability, maintainability, security, or independence across deployed instances.
...
**Provider responsibility / evidence level:** The provider responsibility in this section is to make data control practically intelligible: operators and users should be able to see what data is stored, what can be exported, what depends on external services, and which operational duties remain after self-hosting. The current evidence supports an architectural-reasoning and implementation-traceability claim about data sovereignty and portability; it does not prove tested portability, privacy outcomes, or operator competence across independent deployments.
...
3. **Protocol-Oriented Portability:**
   - ATProto/PDS-oriented records can support a stronger portability model than a provider-specific API when implemented carefully
   - User identity and selected event records should be designed so they can become usable across multiple aligned applications rather than only inside one hosted Event instance
   - OAuth scopes, handle resolution, record schemas, moderation boundaries, deletion/export behavior, and operator documentation must remain explicit so portability does not become a vague marketing claim
   - Current thesis claims should describe ATProto work as implementation groundwork and design direction unless later evidence verifies mature public interoperability

4. **Consent-Scoped Contact Data:**
   - Attendee email sharing with organizers should be separate from the act of registering for an event unless the event itself genuinely requires direct organizer contact
   - Consent records should identify the organizer, event or organization context, contact purpose, and withdrawal state rather than treating the email address as a permanent organizer asset
   - Privacy settings should allow users to withdraw future organizer contact-sharing consent from the Event platform side
   - The interface should explain that exported email lists create downstream responsibilities outside the platform's direct control, so organizers must still provide unsubscribe and deletion paths for their own mailing tools
...
- **Provider responsibility:** Treat security, privacy, fraud-risk controls, and data rights as continuing operational obligations rather than optional technical enhancements.
- **Heuristics Applied:**
  - Security as moral obligation
  - Minimize data collection
  - Transparent data usage
- **Evidence level:** Current evidence is architectural and design-reasoning traceability. It does not establish production security, privacy compliance, fraud reduction, or user trust without future audits, incident review, operational monitoring, and stakeholder feedback.

![figure islamu event security](../30-Resources/Thesis/figure_islamu-event-security.png)
...
5. **Security Boundary and Operational Assurance:**
   ISLAMU Event should not depend on being obscure, small, or uninteresting as a security boundary. A privacy-first Islamic service should assume that public scanning, source-code exposure, dependency compromise, CI/CD token theft, or developer-tool compromise are foreseeable classes of risk. This does not mean claiming production-grade assurance before audits exist; it means designing the architecture so that one exposed detail or one compromised component does not automatically expose all users.
   - Treat CI/CD workflows, deployment credentials, package managers, developer extensions, and third-party actions as part of the trust boundary
   - Prefer least-privilege tokens, scoped access, short-lived or easily rotated secrets where feasible, and documented secret-rotation procedures
   - Pin or verify security-sensitive build and deployment dependencies where practical, and review updates before they affect production paths
   - Give special review attention to authentication, authorization, tenant isolation, admin APIs, upload handling, and data export/deletion flows
   - Record known security gaps explicitly so that limitations remain visible and can be prioritized rather than hidden behind broad security claims

6. **Fraud-Risk and Identity-Governance Considerations:**
...
7. **GDPR-Oriented Data-Rights Requirements and Beyond:**
    ...
    - Separate personally identifying data from operational event records where feasible, so privacy duties are easier to audit, minimize, retain, delete, and export proportionately
    - Keep audit logs for sensitive administrative, access-control, data-export, deletion, and configuration-change events while avoiding log content that recreates unnecessary surveillance
    - Treat future enterprise identity integrations such as SSO or directory synchronization as privacy and access-control responsibilities, not merely sales features
...
**Provider responsibility / evidence level:** The provider responsibility in this section is to define who receives moderation reports, what evidence is required, how temporary restrictions are justified, and how correction or appeal remains possible. The current evidence supports a governance-reasoning and implementation-traceability claim about moderation responsibilities; it does not prove fair enforcement, effective abuse response, scam reduction, or user trust without deployment evidence, incident review, and stakeholder feedback.
...
![figure moderation verification appeal workflow](../30-Resources/Thesis/figure_moderation-verification-appeal-workflow.png)

**Alt text/textual representation** A structural workflow diagram titled 'ISLAMU Event Moderation and Appeal Workflow: A Governance Approach.' It channels event submissions and abuse reports through a risk triage stage into human review and verification. Decisions are made (approve, restrict, reject, escalate) followed by notifications. Loopbacks show explicit paths for appeal or correction, with the entire workflow feeding into an internal audit and governance review for accountability and policy improvement. A final dashed boundary explicitly states claims of operational performance require future data.
...
**Provider responsibility / evidence level:** The provider responsibility in this section is to make interface choices honest, non-coercive, and accessible enough to be reviewed: pricing, defaults, upgrade paths, development-state notices, accessibility requirements, localization, and instance choices should be visible rather than manipulative. The current evidence supports design-reasoning and implementation-traceability about reducing deception, lock-in, and exclusion risk; it does not prove achieved usability, accessibility compliance, translation quality, or user trust without user testing, assistive-technology testing, translation review, accessibility audit, and feedback from affected communities.

**Specific Design Choices:**

![figure dark pattern interfaces vs i vsd interface](../30-Resources/Thesis/figure_dark-pattern-interfaces-vs-i-vsd-interface.png)

**Alt text/textual representation** A two-panel wireframe comparing choice architecture. Panel A shows a manipulative interface featuring fake urgency text, preselected recurring options, and a prominent accept button with hidden opt-outs. Panel B shows a matching, ethical layout featuring neutral text, equal choice formatting, clear pricing breakdowns, and transparent cancellation paths. Annotations highlight how the design shifts from coercive pressure to honest, non-coercive consent.
...
**Provider responsibility / evidence level:** The provider responsibility in this section is to make public claims traceable to evidence: feature descriptions, roadmap promises, metrics, comparisons, reviews, and outreach frequency should be understandable, sourced where needed, and limited to what the provider can actually support. The current evidence supports communication-design reasoning and implementation-traceability about truthful marketing; it does not prove market trust, customer satisfaction, communication effectiveness, or competitive superiority without deployment evidence, source review, user feedback, and ongoing claim maintenance.
...
1. **Truthful Claims:**
   ...
   - Compliance and security wording limited to what evidence supports: for example, "privacy-oriented architecture," "supports governance workflows," or "designed to support regulated deployments" rather than certification or legal-compliance claims without audit/legal evidence
...
3. **Email Communication:**
    ...
    - Operational emails, such as authentication, receipts, registration confirmations, and safety notices, kept separate from marketing or organizer outreach
    - Attendee contact sharing with organizers controlled by explicit consent and later privacy-preference changes, not inferred from registration alone
     - **Anti-pattern avoided:** Multiple emails per day spam (Section 2.1.3.24)

4. **Sustainability Language:**
   - Paid tiers described as subscriptions, service plans, hosting support, or continued-development funding according to what the user is actually buying
   - Avoid "support us" or emotional supporter framing inside ordinary pricing flows when the transaction is primarily commercial
   - Community funding, donations, and sponsorships kept clearly distinct from product access pricing
...
**Provider responsibility / evidence level:** The provider responsibility in this section is to keep future AI assistance constrained, disclosed, reviewable, and reversible: limitations should be visible, permissions should be scoped, human review should remain available for high-impact actions, and AI-assisted changes should leave audit trails. The current evidence supports future-feature governance reasoning and implementation-traceability about AI boundaries; it does not prove safe deployment, unbiased outputs, reliable automation, secure agent behavior, or harm prevention without model/vendor review, bias testing, permission audits, incident logging, user-facing disclosure checks, human-review workflows, and post-deployment monitoring.
...
The same caution applies to AI-assisted development practices. Rapid AI-generated implementation may be acceptable for prototypes, internal exploration, or low-risk experiments, but it should not become an excuse to bypass review, tests, threat modeling, or domain understanding in production code. ISLAMU Event should therefore treat any AI-assisted code as ordinary untrusted code until it has passed the same architecture, security, privacy, accessibility, and regression checks expected from human-written code.
...
**Provider responsibility / evidence level:** The provider responsibility in this section is to make maintenance duties visible and bounded: security disclosure, support channels, deprecation criteria, continuity options, backup/restore guidance, upgrade paths, and sponsor or governance influence should be inspectable before users depend on the service. The current evidence supports maintenance-stewardship reasoning and implementation-traceability about operational responsibility; it does not prove long-term sustainability, production reliability, mature support operations, backup or upgrade success, guaranteed continuity, or community resilience without operational history, incident review, support metrics, maintainer capacity, and user or operator feedback.
...
For self-hosted or enterprise operators, maintenance stewardship also includes shared-responsibility documentation. ISLAMU should explain which duties belong to the upstream software project, which belong to the hosting operator, and which require professional review or external audit. Audit-log coverage, backup and restore guidance, upgrade procedures, identity-provider configuration, security-disclosure routing, and data-retention settings are not only enterprise sales requirements; they are ways of making operational responsibility inspectable. This does not establish SOC 2, ISO 27001, HIPAA, FedRAMP, GDPR, or any other certification. It only supports the narrower claim that the software is designed to make such review more possible.
...
**Provider responsibility / evidence level:** The provider responsibility in this section is to treat compliance as an accountable review process rather than a badge: data-rights workflows, terms changes, jurisdictional assumptions, Islamic-ethics escalation points, and AI/CLI support boundaries should be visible and reviewable. The current evidence supports compliance-architecture reasoning and implementation-traceability about obligations and review support; it does not prove legal adequacy, Sharia certification, moral compliance, jurisdictional coverage, or regulatory readiness without professional legal review, scholar consultation where needed, practitioner testing, audit records, and deployment evidence.
...
4. **Consent and Contact Governance:**
   - Separate necessary operational email from optional marketing, organizer outreach, partner communication, or newsletter contact
   - Record consent scope for attendee-to-organizer contact sharing and provide user-facing withdrawal controls for future platform-mediated sharing
   - Explain that exported organizer lists create downstream obligations that the organizer must honor through unsubscribe, deletion, and lawful processing paths
   - Treat consent logs as accountability evidence, not as a license to contact users beyond the scope they accepted

5. **Trust Center and Evidence Portal:**
   ISLAMU can treat a trust center as a practical expression of the compliance-plus-ethics approach. A trust center should not be a decorative badge page or a claim that legal compliance exhausts trust. It can collect evidence links, policies, subprocessors, data-rights procedures, security-disclosure information, known limitations, audit status, and I-VSD review notes in one place so users, organizers, and potential partners can evaluate the organization's promises.
   - **Evidence status:** design direction and evidence-organization mechanism; not proof of certification, legal adequacy, operational maturity, or moral compliance.
   - **Boundary:** a trust center should clearly distinguish implemented controls, planned controls, external audits, self-assessments, and unresolved gaps.

6. **Enterprise Readiness and Shared Responsibility:**
   Enterprise use often requires stronger review of privacy, security, access control, auditability, identity integration, and operational responsibility. For a self-hostable application, these duties are shared: ISLAMU may provide software features, documentation, and defaults, while the hosting organization remains responsible for deployment configuration, access management, backups, staff processes, jurisdictional duties, and audits.
   - Support audit logs for account, role, configuration, data-export, deletion, and security-sensitive changes where feasible.
   - Make PII separation, retention settings, deletion workflows, and portability procedures explicit enough for review.
   - Treat SSO, SAML, SCIM, directory synchronization, and enterprise access-policy integrations as possible future readiness features, not as current proof of enterprise compliance unless separately evidenced.
   - Avoid claiming SOC 2, ISO 27001, HIPAA, FedRAMP, GDPR compliance, or similar certification without qualified review and audit evidence.
   - Public wording should distinguish product capabilities, deployment compatibility, audit preparation, active audit work, completed audits, and certified organizational controls so that buyers are not invited to infer more evidence than exists.

7. **Framework Implementation Support:**
...
- **Event decision:** ISLAMU Event treats compliance as a minimum layer and frames consent records, trust-center evidence, enterprise-readiness documentation, and I-VSD tooling as practitioner support rather than automatic certification.
...
This section closes the `4.4` technical and architectural branch. It should not be read as a replacement for 4.2.7, which summarizes the broader `4.2` application branch. Here the focus is narrower: how the framework appears in technology stack selection, data architecture, security and privacy, moderation, interface design, marketing and communication, AI governance, maintenance, and legal/compliance architecture.
...
| Legal and compliance support | Compliance treated as floor plus ethical review support, consent records, trust-center evidence organization, and enterprise-readiness documentation | Trust, Justice, Promise-Keeping, Truthfulness | Governance, Operational, Evaluation | Support and evidence-organization mechanism, not evidence of legal certification or moral compliance. |

The detailed homes for these rows are the preceding `4.4` sections: stack choices in 4.4.1, data architecture in 4.4.2, security and privacy in 4.4.3, moderation in 4.4.4, interface and accessibility decisions in 4.4.5, communication strategy in 4.4.6, future AI boundaries in 4.4.7, maintenance and support in 4.4.8, and legal/compliance architecture in 4.4.9.
...
The framework connects ethical considerations across software development, from strategic decisions to implementation details. By relating these decisions to selected Islamic principles, it provides a consistent structure for provider responsibility.

**Practical Actionability:**
Unlike purely philosophical approaches, I-VSD translates abstract principles into concrete heuristics that developers and business leaders can use as review prompts.

**Cultural Alignment:**
For Muslim developers and organizations, the framework offers a way to connect professional software decisions with Islamic moral commitments.

**Preventive Approach:**
By identifying industry anti-patterns and Islamic alternatives, the framework makes risks visible earlier in the design process.

**Holistic Scope:**
The framework extends beyond technical concerns to business models, marketing, partnerships, and organizational structure.
...
Its value is therefore not that many independent actors have already adopted the framework. Rather, it shows that the framework is not only aspirational: the same person proposing the framework has attempted to apply it to concrete software decisions, where tradeoffs become visible. This matters because a framework with no worked case would leave readers guessing whether even its author would choose it over convention when practical constraints appear.
...
This is stronger than a purely hypothetical design example because the current case includes repository and documentation artifacts that can be inspected for architecture, authorization, data stewardship, accessibility, localization, self-hosting, testing, and operational posture. It remains weaker than empirical validation because those artifacts do not measure real-world outcomes.
...
I-VSD addresses several gaps in existing ethical frameworks for provider-mediated software:

1. **Religious Value Integration:**
   Many frameworks ignore religious values or treat them as individual preferences. I-VSD treats selected Islamic values as foundational to the provider's responsibilities.

2. **Business Model Ethics:**
   Standard approaches often give limited attention to funding sources, investor relationships, and organizational structure. I-VSD brings these choices into ethical review.

3. **Comprehensive Lifecycle Coverage:**
   Many frameworks focus on design or development phases. I-VSD follows provider responsibility from conception through maintenance and discontinuation.

4. **Moral Boundaries:**
   In contexts where moral boundaries matter, I-VSD uses selected Islamic principles to identify limits that should not be reduced to preference or negotiation.

5. **Community-Specific Needs:**
   Muslim communities may have specific needs, such as permissible content, privacy from surveillance, and trustworthy religious or community infrastructure, that general frameworks may not address in detail.

### 5.2 Challenges and Limitations

This section identifies the main limits of the framework and case study. These limitations do not invalidate I-VSD as a design-reasoning framework, but they define the evidence level at which the thesis should be read: conceptual construction, implementation traceability, and future validation requirements rather than completed empirical proof.

#### 5.2.1 Challenges Encountered

**Challenge 1: Dual-Use Technology Dilemmas**

Dual-use tools remain difficult because the same technical capability can support legitimate privacy or harmful activity. The relevant I-VSD response is not to classify the technology in isolation, but to assess intention, predominant use, probability of harm, and provider controls, while recognizing that probability thresholds remain difficult to define in practice.

**Challenge 2: Competitive Pressure**

Ethical operation can create competitive pressure when other providers rely on dark patterns, aggressive marketing, or data monetization. A nonprofit structure and long-term orientation can reduce some pressure to compromise, but they do not remove the practical tension between sustainability and refusing unethical practices.

**Challenge 3: Technical Implementation Complexity**

Some ethical requirements are technically difficult to implement completely. Privacy is the clearest example: as Section 2.1.3.4 notes, perfect privacy is not achievable in practice. The provider responsibility is therefore to be transparent about limitations, implement appropriate safeguards, and keep improving as threats evolve.

**Challenge 4: Stakeholder Education**

Stakeholders may not immediately understand why Islamic ethical requirements change familiar software expectations. Users accustomed to "free" ad-supported services may question sustainable pricing or slower growth. This creates an ongoing need for clear explanation, community education, and honest communication about tradeoffs.

**Challenge 5: Evolving Technology Landscape**

New technologies such as AI and blockchain create questions that cannot always be answered by direct analogy. I-VSD can return to foundational principles such as trust, justice, and avoiding harm, but complex cases still require ongoing scholarly consultation and technical expertise.

**Challenge 6: Measurement and Validation**

Ethical outcomes are difficult to measure because concepts such as trustworthiness and respect cannot be reduced to a single technical metric. Qualitative assessment, user feedback, third-party audits, and incident review can provide evidence, but they remain less precise than many technical measurements.
...
![figure i vsd validation roadmap](../30-Resources/Thesis/figure_i-vsd-validation-roadmap.png)
...
Privacy-preserving technologies such as zero-knowledge systems can be ethically valuable, but they also introduce operational risks:

**End-to-End Encryption Example:**

Services such as ProtonMail and ProtonDrive use end-to-end encryption where:
...
| Benefit | Risk |
|---------|------|
| Strong privacy from provider | **No data recovery if key is lost** |
| Protection from government overreach | **No password reset possible** |
| Reduced need to trust provider access | **Business continuity can be threatened** |
| Protection from data breaches | **No redundancy or backup by provider** |

**Operational Consequences:**
- Businesses can lose all data if encryption keys are lost
- Recovery may be impossible because the encryption is designed to be mathematically unbreakable
- Years of work, client communications, and financial records may become inaccessible
- The same feature that protects privacy can become a serious continuity risk
...
The I-VSD framework therefore treats privacy architecture as a contextual responsibility rather than a single technical ideal:
1. **Assess the actual threat model:** who the data is being protected from
2. **Consider the consequences of loss:** whether the data can be recreated or recovered through other means
3. **Use hybrid approaches where justified:** zero-knowledge protection for sensitive data and trusted backup for essential continuity data
4. **Educate users clearly:** especially about irreversible loss risks
...
Sector risk intensifies this limitation. In a casual or low-impact application, rapid prototyping and AI-assisted coding may be acceptable when the consequences of failure are small and review remains proportionate. In banking, health, legal, safety-critical, or other high-stakes settings, the same development style becomes morally different because defects can affect wealth, privacy, access to care, legal rights, or public trust. I-VSD therefore does not treat a development technique as ethical or unethical in isolation. It asks whether the level of human review, testing, documentation, security assurance, and operational control is proportionate to the harms that foreseeable failure could cause.

This also means that "vibe coding" should not be treated as a single moral category. The ethically relevant question is whether the provider understands the generated system, can maintain it, can explain its risks, and has tested the parts that affect users. Unverified statistics about AI-generated vulnerabilities may motivate caution, but they should not replace direct review of code, threat models, test coverage, and deployment context.

#### 5.2.4 The Role of Trust in Ethical Business Relationships

**Trust is Not Inherently Bad**

A potential misreading of this thesis would conclude that trust should be eliminated from all software relationships. That is not the argument. Properly placed trust can support operational resilience, account recovery, business continuity, fundraising, partnerships, community support, simpler user experience, and long-term human cooperation.

**The Problem is Misplaced Trust**

The ethical problem is misplaced, manipulated, or unverifiable trust. This includes trusting providers with documented deception histories, conflicting incentives, previous violations of user trust, or no accountability mechanisms; being influenced by false reviews, authority signals without substance, or emotional manipulation; and accepting claims without evidence or without reading the conditions under which the service operates.

In business-to-business software relationships, misplaced trust can also appear after a contract has already been agreed. A client may become operationally dependent on a provider that promised a software solution, while the provider delays delivery, supplies less than the agreed scope, repeatedly asks for additional payment, or structures ordinary modifications so that only the provider can perform them. The ethical issue is not that every change request must be free, or that every delay proves wrongdoing. The issue is whether the provider uses the client's dependence, urgency, or lack of technical control to turn a legitimate contract into an unequal and disadvantageous relationship.
...
Trust centers make this issue concrete. A useful trust center gathers evidence that users or business partners would otherwise have to request privately: policies, subprocessors, security-contact information, control status, audit reports where they exist, data-rights procedures, known limitations, and incident or vulnerability-handling expectations. Such a page can reduce blind trust by making promises inspectable. At the same time, it must not reduce trust to a checklist. A provider can satisfy common compliance controls while still using manipulative pricing, unfair defaults, deceptive marketing, or exploitative data practices. I-VSD therefore treats trust centers as useful evidence infrastructure, not as proof that the provider is morally trustworthy.
...
**Trust Can Affect Technology Choices**

User testimony also suggests that trust can affect technology choices even when technical tradeoffs are present. A user may prefer a slower, less convenient, or more restrictive tool if the alternative is controlled by an organization whose judgment they do not trust. Conversely, users sometimes make exceptions for closed-source or less portable tools when they trust the organization's incentives, communication, and record of conduct. This does not show that trust should replace technical safeguards; rather, it shows why safeguards exist in the first place. Open source, portability, decentralization, and auditability are often ways to reduce the amount of blind trust a user must place in the provider.
...
At the same time, accountability should be proportionate. Where the problem is uncertain, remediable, or not yet publicly harmful, the first ethical step is often to contact the provider, maintainer, support team, or responsible organization directly. Direct feedback gives the provider an opportunity to correct mistakes without unnecessary reputational damage. Public criticism remains justified when private channels are ignored, the provider is unresponsive or deceptive, users face ongoing harm, or the issue requires broader warning.
...
**Case Examples: Ethical Preference and Negative Outcomes**

**Example 1: Privacy-Focused Social Networks**

Several privacy-focused alternatives to Facebook struggled to sustain mainstream adoption:
- **Ello** (2014): promised no ads and no data selling, but struggled financially and later pivoted to a niche artist platform
- **Diaspora** (2010): decentralized and privacy-focused, but did not reach mainstream scale
- **App.net** (2012): a paid, ad-free Twitter alternative that shut down in 2017

**Possible Contributing Factors:**
- Users were accustomed to "free" ad-supported models
- Network effects favored established platforms
- Sustainable pricing struggled against services subsidized by advertising or venture capital
- Smaller ethical alternatives often had limited marketing budgets compared with venture-backed competitors

**Example 2: Ethical E-commerce Under Competitive Pressure**

Companies that prioritize fair wages, ethical sourcing, and honest marketing can face structural disadvantages:
- Higher costs than competitors that cut corners
- Customers choosing cheaper alternatives despite ethical concerns
- Limited ability to match the marketing budgets of less scrupulous competitors
- Closure despite sincere ethical commitments
...
**The Limitation for I-VSD:**

These examples are illustrative rather than controlled case studies, but they show a real limitation: ethical choices can be costly. They may contribute to:
- Business failure
- Career destruction
- Financial ruin
- Social ostracism
...
This section explains why I-VSD cannot be evaluated only through conventional software metrics such as growth, valuation, or market dominance. It frames success as obedience, integrity, benefit, and accountable provision, while still requiring professional effort and realistic business judgment.

This framing also changes how competition is interpreted. A competitor's success is not, by itself, evidence that one's own provision has been denied or that harmful tactics are justified. The command-oriented lens asks the provider to compete through competence, service, truthfulness, and lawful means while guarding against envy, resentment, and predatory attempts to capture customers merely because another organization succeeded.

#### 5.3.1 The Fundamental Principle

**We Are Commanded to Obey, Not to Succeed**

A critical distinction in Islamic ethics is between obedience (taa'ah), which means following God's commands, and worldly success, which means achieving desired worldly outcomes. For this thesis, that distinction matters because I-VSD does not define ethical software only by market results. The provider is responsible for the action, intention, and effort; the final outcome remains outside human control.
...
This verse establishes the epistemic humility behind the framework: human beings cannot fully predict consequences, divine wisdom exceeds what human beings can see, apparent failures may contain unseen good, and moral action should not depend entirely on visible short-term outcomes.
...
This teaches that outcomes are ultimately decreed by God. The human task is to act rightly, use appropriate means, and trust God with what remains beyond human control.
...
The I-VSD framework therefore rejects optimizing business decisions solely for financial gain. Its success criteria differ from common software-industry metrics: God's pleasure, compliance with Islamic principles, genuine benefit to users, sustainable and permissible operations, and sincere service to others remain central even when financial outcomes are secondary.

**Rejected Rationales**

This is why I-VSD rejects “ends justify means” reasoning. In Islamic ethics, certain actions are intrinsically prohibited regardless of their consequences. A provider cannot pursue a good outcome through prohibited means and then claim that the result justified the method. Arguments such as “we need dark patterns to survive,” “everyone does it,” “users benefit in the end,” “we'll do good later when profitable,” or “it's legal” are therefore insufficient when the action itself violates trust, truthfulness, or justice.
...
Being non-money-oriented does not require pretending that money is irrelevant. Ethical software still requires salaries, infrastructure, security work, support, documentation, and long-term maintenance. The moral distinction is between using money as an accountable means of sustaining service and allowing money to become the master criterion by which all design decisions are judged. Fair compensation can therefore be part of stewardship, while excessive extraction, hidden self-enrichment, or pressure to maximize income at the expense of users would contradict the framework's purpose.
...
When facing ethical dilemmas in software development, I-VSD uses a command-oriented decision framework. The provider identifies the relevant Islamic duty, such as honesty, trustworthiness, justice, or avoiding harm; follows that duty despite projected financial pressure; trusts God with the result; and accepts the outcome without treating worldly success or failure as the measure of whether the ethical choice was right.

In concrete software decisions, this changes what counts as acceptable action. Dark patterns may increase conversion, but the command-oriented choice is to reject manipulation. Selling user data may be profitable, but the command-oriented choice is to protect entrusted information. Lying about features may close deals, but the command-oriented choice is to tell the truth. Unethical investment may provide funding, but the command-oriented choice is to decline it. Cutting corners may save money, but the command-oriented choice is to maintain standards.
...
Being command-oriented does not mean being naive or impractical. It means using permissible means seriously: planning carefully, executing professionally, competing responsibly, and making wise business decisions within ethical bounds. It rejects both unethical pragmatism and careless reliance on religious language to excuse weak work.

The Hadith “Tie your camel and trust in God” (Jami` at-Tirmidhi 2517) gives the full balance. “Tie your camel” means acting with wisdom and skill; “trust in God” means accepting the outcome after one's best effort. Applied to software and business, this requires thorough market research, prudent financial planning, competitive analysis, quality assurance, non-negotiable ethical boundaries, and acceptance of results with gratitude and contentment.

This distinction also applies to pricing. A transparent annual discount or higher monthly price can be a practical business decision when it reflects cash-flow planning, churn risk, payment cost, or service commitments. Yet business reality does not make every pricing pressure morally equal. If the monthly option is intentionally inflated so that users with less upfront capital must pay a punitive premium, the issue is not only contract clarity but fairness, mercy, and the provider's intention. I-VSD therefore separates legal form from moral quality: a clearly displayed price may still require ethical review when it exploits dependency or unequal cash flow.
...
The difference between worldly and ultimate success changes how software metrics are interpreted. Company valuation, user growth, revenue, and market dominance are not automatically good or bad; their moral meaning depends on how they are achieved, what they enable, and how the provider uses them. By contrast, pleasing God, maintaining integrity, and helping others genuinely are not usually captured by conventional software evaluation, yet they are central to Islamic evaluation.
...
This is not an excuse for poor work. It is the rational position for one who believes in God's promise and the reality of the Hereafter.
...
Blessing is a theological concept, not a metric that this thesis can measure. It remains relevant because I-VSD does not treat revenue, growth, engagement, or market share as the only signs of success. Islamic software ethics also asks whether a provider acts with trustworthiness, avoids harm, preserves rights, keeps promises, and serves users without deception.
...
A public open-source example illustrates the analytic point without serving as Islamic evidence. In a 2026 JetBrains interview about the Zig Software Foundation, Andrew Kelley described a board-set salary that he considered sufficient and connected his satisfaction to the health and resilience of the organization rather than to additional personal income. His phrasing was that a healthy organization "fills me with satisfaction that having more income would not fill." For this thesis, the example is not proof of Blessing and should not be overread as a model to copy mechanically. It does, however, show how a software organization can articulate success in terms of stewardship, autonomy, sustainability, and satisfaction rather than pure income maximization.
...
This section collects practical constraints that affect I-VSD implementation in software services. The aim is not to weaken the framework, but to clarify the conditions under which its guidance must be applied carefully: resources, legal context, technical capacity, market pressure, accessibility, organizational culture, and long-term maintenance.

#### 5.4.1 Resource and Market Constraints

The non-profit approach used in the ISLAMU Event case faces real resource limitations. Organizations operating without venture-capital funding may have less capital than VC-funded competitors, resulting in slower growth and fewer initial features. For I-VSD, this is not only a weakness; it can also be an intentional tradeoff for ethical integrity, slower sustainable growth, and reduced pressure toward exploitative scaling.

The framework was developed primarily within a European legal context, where regulations such as GDPR provide strong user-protection foundations. Applying it in regions with different legal requirements would require adaptation and is therefore an area for future development.

**Compliance Evidence and Audit Costs**

Trust evidence also has a resource dimension. Compliance monitoring platforms, security audits, certification work, penetration tests, legal review, and privacy documentation can be expensive, especially for small non-profit or early-stage projects. This creates an ethical tension: serious providers should be able to show users and enterprise clients that controls, subprocessors, retention policies, access rules, and security practices are not merely promises, but the cost of formal proof can exclude smaller actors.

For ISLAMU, the appropriate response is not to claim certifications before they exist. A more realistic path is to build a lightweight trust center and evidence ledger that makes current controls, gaps, subprocessors, security contacts, data-rights workflows, and audit status visible. This cannot replace professional audits where they are required, but it can express Excellence by making trust more inspectable even before expensive third-party assurance is affordable.
...
This thesis should not make sweeping claims that capitalism inevitably collapses or that all automation is harmful. The narrower I-VSD concern is that short-term cost optimization can undermine sustainable human capacity. Ethical software organizations should therefore consider how automation affects training, review responsibility, labor dignity, and the long-term health of the communities and markets on which they depend.

**Client Dependence and Market Power in Custom Software**

Resource constraints also affect clients, not only providers. In custom software work, a client may urgently need a system and may lack the technical capacity to evaluate architecture, maintainability, or whether later modification costs are reasonable. This asymmetry can create a market temptation for providers to under-deliver, make excuses, or design the solution so that ordinary future changes require paid intervention. I-VSD does not imply that all scope changes should be free; rather, it requires the provider to distinguish fair compensation for new work from exploiting dependence created by unclear contracts, avoidable lock-in, or incomplete delivery.

The same asymmetry appears in subscription pricing. Annual plans can help a provider stabilize cash flow, but they also privilege users who have enough capital to pay upfront. Users with tighter budgets may be forced into more expensive monthly plans even when their total need is similar. I-VSD does not forbid term-based discounts, but it asks providers to review whether the pricing gap is proportionate to real cost and risk or whether it extracts more from users precisely because they have less liquidity.

#### 5.4.2 Framework Formalization

The I-VSD framework currently expresses its guidance through heuristics and principles rather than formal specifications. This gives practitioners flexibility, but it also makes consistent application harder. Future work could develop structured checklists, decision trees, traceability templates, or limited logical representations that help teams apply the framework more consistently.

The accompanying `i-vsd` agentic skill should be understood as an early formalization artifact in this direction. It does not mathematically formalize Islamic moral judgement, but it does translate the framework into bounded review actions, context-discovery gates, report templates, evidence-level categories, implementation-review workflows, and scholarly-escalation boundaries. In design-science terms, this supports artifact and method traceability: it shows that I-VSD can be expressed as a repeatable practitioner-support process while leaving validation, scholarly review, and operational outcome assessment to future work.

The skill's file architecture is itself part of the formalization design. A portable Markdown folder allows the method to travel into a host repository without requiring one specific AI platform. The entrypoint states when the workflow should load, the resource index gives future agents a reading order, the action router maps practitioner intents to specific report files, the context gate requires evidence review before findings, and the report templates make claim boundaries mandatory. This is a lightweight formalization: the structure constrains the review process, preserves evidence categories, and creates durable artifacts, but it does not calculate a moral verdict.

This limitation is important for later tooling. The `i-vsd` skill can ask an agent to inspect a git diff, compare implementation changes with the framework, and classify findings in a structured way, but it should not be responsible for the deterministic enforcement logic of a software pipeline. A future governance layer should therefore separate semantic interpretation from mechanical gatekeeping. In that model, the agentic skill would identify possible I-VSD concerns, missing evidence, hard violations, soft warnings, and escalation needs, while an external policy engine would count findings, apply thresholds, preserve evidence, and decide whether a local commit, pull request, or deployment step may proceed. This would strengthen formalization without pretending that Islamic moral judgment has been reduced to arithmetic: the arithmetic would govern only the workflow consequence of already-declared review categories.

![figure semantic interpretation vs deterministic enforcement](../30-Resources/Thesis/figure_semantic-interpretation-vs-deterministic-enforcement.png)

**Alt text/textual equivalent:** Split diagram showing an agentic I-VSD review component reading repository context and classifying findings, then handing structured findings to a deterministic policy engine that applies thresholds, preserves evidence, and returns pass/fail without claiming to understand or certify Islamic moral judgment.

| Formalized artifact layer | I-VSD implementation role | Limitation |
| --- | --- | --- |
| Skill entrypoint | Defines scope, loading conditions, anti-patterns, invariants, and portability assumptions. | It cannot force every host agent to reason well unless the agent actually follows the resources. |
| Resource index | Provides an agent-readable path through routing, scope, context, principles, derivation, evidence, scholarly boundaries, workflows, and domains. | A reading order improves consistency but does not replace training, review, or external expertise. |
| Action-to-report map | Connects requests to named `i-vsd-*.md` outputs such as architecture review, AI/data review, implementation-code review, guided discovery, or moral-diff review. | Deterministic filenames support traceability; they do not prove the findings are complete. |
| Context and evidence gate | Requires repository, policy, operational, implementation, stakeholder, or user-provided evidence and records missing evidence. | Missing evidence remains a validation gap, not a basis for stronger claims. |
| Claim-boundary and escalation rules | Require refusal or escalation for unrelated requests, religious-legal authority questions, contested finance, high-stakes AI/privacy, public harm, and other specialist matters. | Escalation marks the limit of the artifact rather than resolving the issue inside the tool. |

![figure formalized artifacts layers](../30-Resources/Thesis/figure_formalized-artifacts-layers.png)

**Alt text/textual equivalent:** Layered diagram showing how the `i-vsd` skill formalizes I-VSD through resources, gates, routing, reports, and evidence boundaries while leaving validation and authority questions outside the artifact.

This future formalization path should draw on the strongest adjacent design traditions rather than inventing a disconnected checklist. Design science research frames I-VSD as a construct, model, and method artifact that can be iteratively built, demonstrated, and evaluated rather than merely asserted. Value-based Engineering and IEEE 7000 offer a more operational bridge from values to system requirements, responsibilities, and verification activities. Accountability work such as datasheets for datasets shows how documentation can make data assumptions, provenance, intended uses, and limits visible. Formal fairness work, including equality-of-opportunity and counterfactual-fairness approaches, illustrates how some ethical concerns can be translated into measurable constraints while still requiring careful normative interpretation.

In practical terms, a later formalization layer could use the following progression:

| I-VSD step | Stronger source family | Formalization function |
| --- | --- | --- |
| Islamic source grounding | Quran, hadith, classical and contemporary Islamic ethical scholarship | Identify selected principles and the boundaries of their use in this thesis. |
| Artifact development | Design science research | Treat the framework as a design artifact requiring demonstration, evaluation, and iteration. |
| Value translation | VSD and Value-based Engineering | Translate values into stakeholder concerns, requirements, controls, and review questions. |
| Evidence documentation | Datasheets and accountability documentation | Record provenance, assumptions, intended use, limitations, and evidence level. |
| Agentic practitioner support | `i-vsd` action routing, context discovery, report templates, host-repository report outputs, and moral-diff review | Convert heuristics into bounded review workflows, implementation-traceability reports, missing-evidence records, and escalation records. |
| Measurable subproblems | Formal fairness, privacy, security, and accessibility methods | Apply metrics only where a normative concern can be responsibly operationalized. |
| Governance alignment | NIST AI RMF, UNESCO AI ethics, the EU AI Act, and automated-decision governance tools | Map review, risk management, auditability, human oversight, and escalation responsibilities. |

![figure report contract evidence ladder](../30-Resources/Thesis/figure_report-contract-evidence-ladder.png)

**Alt text/textual equivalent:** Diagram showing that each `i-vsd` report records scope, evidence, gaps, recommendations, and escalation while separating artifact traceability from stakeholder, operational, and scholarly validation.

This table is a research agenda for strengthening I-VSD, not evidence that the present thesis has already completed all of these formalization steps.

##### Governance and Policy Alignment

I-VSD should also be alignable with current governance and policy instruments, but this alignment has a limited function. The instruments below can support auditability, documentation, risk management, and lifecycle review. They do not supply the Islamic moral authority of the framework, and compliance with them would not by itself make a system ethically sufficient under I-VSD.

| Governance or policy instrument | Useful governance function | I-VSD use | Boundary |
| --- | --- | --- | --- |
| NIST AI Risk Management Framework | Risk mapping, measurement, management, and governance vocabulary. | Use as a structure for identifying AI-related harms, controls, monitoring duties, and review records. | It is a risk-management framework, not an Islamic normative source or proof of moral acceptability. |
| OECD AI Principles | Broad responsible-AI principles such as human-centered values, transparency, robustness, accountability, and inclusive growth. | Use as a comparison vocabulary when I-VSD evaluates AI-enabled software responsibilities. | Broad principles still require local interpretation, stakeholder evidence, and Islamic red-line review. |
| UNESCO Recommendation on the Ethics of AI | Human-rights, dignity, inclusion, governance, and impact-assessment orientation. | Use to widen the policy lens beyond technical performance and include social impact, inclusion, and institutional responsibility. | UNESCO alignment can support responsible governance but cannot replace Islamic scholarly review where religious duties are at stake. |
| EU AI Act | Risk classification, high-risk obligations, documentation, transparency, human oversight, and post-market monitoring. | Use as a concrete model for classifying AI-system risk, evidence duties, and lifecycle monitoring where EU-facing systems are relevant. | Legal compliance is jurisdiction-specific and does not exhaust moral responsibility. |
| Council of Europe AI Convention | Human rights, democracy, rule of law, and public accountability frame for AI systems. | Use to identify institutional safeguards, accountability duties, and public-interest risks in high-impact systems. | Its authority is legal-political, not theological; I-VSD still needs its own normative grounding and scope limits. |
| Canada Directive on Automated Decision-Making and Algorithmic Impact Assessment | Impact assessment, risk levels, explanation, recourse, testing, and monitoring for automated public-sector decisions. | Use as an example of structured pre-deployment assessment and ongoing governance for automated decision systems. | It is most directly relevant to automated decision contexts and cannot be generalized to all software without adaptation. |

For future implementations, the governance layer could be expressed as an audit model:

| Audit component | Minimum I-VSD question | Evidence object |
| --- | --- | --- |
| Stakeholder map | Who is affected directly, indirectly, or asymmetrically by the provider's design, data, policy, or business-model choices? | Stakeholder register, affected-group notes, missing-stakeholder log. |
| Rights and harms register | What rights, interests, duties, and foreseeable harms are implicated? | Harm register, rights-impact notes, risk classification, unresolved tensions. |
| Red-line review | Are any proposed features, incentives, claims, data practices, or financial arrangements prohibited or non-negotiable within the framework's selected ethical scope? | Red-line checklist, scholar/practitioner escalation record, decision memo. |
| Traceability matrix | Can each major requirement or control be traced back to a principle, stakeholder concern, evidence source, and limitation? | Principle-to-requirement-to-control matrix, evidence-level labels. |
| Review intervals | When must the decision be revisited after deployment, policy change, incident, model update, or stakeholder complaint? | Review calendar, change log, post-deployment monitoring plan. |
| Appeal and recourse | Can affected stakeholders challenge, correct, leave, export, or escalate decisions that affect them? | Appeal process, support records, response-time targets, portability path. |
| Incident reporting | How are failures, harmful outcomes, misleading claims, privacy events, or security issues recorded and communicated? | Incident log, public/private disclosure rules, remediation record. |
| Lifecycle re-evaluation | Does the system remain aligned after scale, monetization, ownership, infrastructure, model, or jurisdiction changes? | Lifecycle audit report, dependency review, governance revision notes. |

This audit model turns governance into an artifact rather than a theme. Its purpose is to make I-VSD decisions inspectable over time while preserving a clear distinction between Islamic ethical governance, legal compliance, standards compliance, and ordinary risk management.

Such tooling should support review rather than replace judgment. Automated checks could make the framework more accessible to teams without deep expertise in Islamic ethics, but they would not certify moral compliance or remove the need for scholarly consultation where a question becomes jurisprudentially complex.

When Islamic principles appear to conflict in specific situations, the current approach relies on case-by-case analysis and qualified consultation. A more formalized decision framework for principle conflicts would improve practical utility while preserving the need for accountable human review.

#### 5.4.3 Implementation Requirements

I-VSD implementation requires competencies that are not always present in one person: understanding of Islamic principles, software-development expertise, business judgment, and operational responsibility. Interdisciplinary teams can combine these competencies more reliably than isolated practitioners. Educational resources, review templates, and practical examples would help bridge knowledge gaps without pretending that a checklist alone can replace expertise.

#### 5.4.4 Market Education Challenge

Users who are accustomed to zero-price software may not immediately understand why an ethically constrained service asks for sustainable payment, limits monetization, or rejects data-extractive business models. The issue is not only pricing; it is education about what the provider refuses to do.

For I-VSD, market education is therefore part of provider responsibility. Users need clear explanations of what they are paying for, which practices are being avoided, and why slower or less aggressive growth may be connected to ethical limits. This does not guarantee adoption, but it makes the tradeoff honest.
...
Ethical implementation has material costs. Accessibility support for disabled users, older devices, and diverse usage contexts requires design and development time. Security reviews, audits, and certifications can be expensive. Multi-language support for a global Muslim community requires translation, localization, and maintenance effort.

These constraints require prioritization and phased implementation, especially for small or nonprofit providers. However, treating accessibility, security, and internationalization as optional extras would weaken the framework's integrity. They are not merely competitive advantages; they are areas where provider responsibility becomes technically and financially demanding.

#### 5.4.7 Short-Term vs. Long-Term Thinking

A central question for any I-VSD implementation is time horizon. Ethical constraints can reduce short-term growth, revenue, or convenience, especially when a provider refuses manipulative design, exploitative monetization, or misleading marketing. The organization must decide whether immediate returns justify those methods, or whether slower growth is part of principled operation.

I-VSD favors long-term thinking aligned with patience, trust in God's provision, and responsible use of means. This does not remove the need for financial planning. A provider still needs enough runway, operational discipline, and realistic resource planning to survive while refusing unethical shortcuts.

#### 5.4.8 International and Accessibility Considerations

Software services applying I-VSD should account for the global and economically diverse nature of the Muslim community. Pricing may need to reflect differences in purchasing power across countries. Student discounts, nonprofit rates, and recognition for open-source contributors can support access for people seeking knowledge or serving the community.

Accessibility also extends beyond disability accommodations. Older devices, limited bandwidth, unsupported operating systems, and regional hardware constraints can determine whether users can participate at all. Text-to-speech functionality, keyboard navigation, and image descriptions serve users with visual impairments while also helping users with limited literacy or difficult usage conditions. Multi-platform support can reduce the risk that users are forced into specific hardware ecosystems.

Translation support for major languages can serve a diverse Muslim community, although resources will often limit how much localization is possible. Prioritization should consider both population size and underserved communities.


Accessibility also has economic and cultural dimensions. Profit-driven prioritization can underestimate accessibility because the direct return on investment appears smaller than features for the majority. I-VSD challenges that calculation. If software claims to serve a community, excluding users because their needs are numerically smaller is not a neutral prioritization choice; it is a moral tradeoff that must be acknowledged.

Universal design reduces this tension because many accessibility practices benefit wider groups than the original target: captions help users in noisy spaces, semantic markup improves navigation, clear contrast helps outdoor mobile use, and keyboard support helps both disabled and expert users. Internationalization should be treated similarly. Cultural awareness, language support, device constraints, and accessibility are not separate "edge cases"; they are part of respecting the diversity of the community the software claims to serve.


Accessibility is not an optional enhancement; it is part of whether a product meaningfully serves the people it claims to serve. Laws and standards provide a legal floor rather than an ethical ceiling. I-VSD asks whether users with disabilities, older devices, limited bandwidth, cognitive load, or different cultural expectations can participate without being treated as edge cases.
...
I-VSD cannot be limited to an organization's direct practices. A software service may follow the framework internally while still depending on infrastructure providers, third-party libraries, payment processors, or cloud services whose practices raise ethical concerns.

This creates both constraints and possible advantages. On the constraint side, organizations applying I-VSD may find that industry-standard, low-cost solutions are ethically difficult to justify. Hosting on major cloud providers whose parent companies engage in controversial practices, using libraries with exploitative licensing, or depending on services that monetize user data can undermine the ethical consistency of the service even when its own internal policies are careful.
...
The same constraint can also create resilience. More careful supply-chain choices may reduce exposure to unpredictable pricing changes, license modifications, broken promises, and reputational damage by association. Organizations that prioritize ethical consistency over pure cost minimization can also help sustain alternatives that would otherwise struggle to compete.

The consumer dimension also matters. Unethical software services persist partly because users and institutions tolerate or choose them. When organizations and consumers give weight to ethical consistency, market incentives can shift. I-VSD's broader contribution is therefore not only internal organizational guidance, but also a vocabulary for more accountable software ecosystems.


**License Compliance and Reciprocity**

Supply-chain ethics also includes respecting the licenses, authorship, and reciprocal expectations of upstream projects. A software organization may use clean-room implementation, protocol reimplementation, permissive-license boundaries, specification copying, AI-assisted reconstruction, or compatibility engineering for legitimate interoperability. This thesis should not treat those methods as inherently unlawful. The moral question is narrower: whether the organization is using legal form to support compatibility and user freedom, or to capture open-source benefits while avoiding reasonable duties of attribution, reciprocity, or community respect.

Public license disputes illustrate why caution is necessary. Alleged GPL, LGPL, AGPL, trademark, or attribution conflicts can damage trust even before courts or maintainers settle every legal detail. Public reports such as the Rockchip/FFmpeg DMCA dispute should therefore be handled carefully because the thesis is not a court. The safer lesson is broader: verify license obligations, keep notices and attribution intact, document provenance, avoid relicensing code without authority, respond to maintainers in good faith, and treat upstream communities as stakeholders rather than obstacles. If an organization benefits from a commons, it should not search only for loopholes that let it extract value while weakening that commons.

Contributor license agreements and copyright assignment policies belong in the same ethical category. They can make commercial support, dual licensing, or long-term stewardship easier, but they can also shift power from contributors to founders or companies. Without doing a separate legal case study here, the I-VSD lesson is that relicensing authority should be transparent before contributors invest work and before users build dependence. A community project should not borrow the trust symbolism of open collaboration while hiding whether maintainers can later sell, close, or relicense community contributions in ways contributors did not reasonably expect.
...
**Build and Developer Tooling as Supply Chain**

Supply-chain ethics also reaches the development and deployment pipeline. A provider may carefully review application code while implicitly trusting package managers, CI/CD actions, developer extensions, build scripts, scanners, deployment credentials, and package-publishing tokens. Practitioner warnings about the decline of security by obscurity are useful here because they show why a service should not assume that obscure code, niche deployment, or delayed public vulnerability disclosure will protect users. Even if each reported incident still requires primary-source verification before being used as academic evidence, the design implication is clear: the software supply chain is part of the moral trust boundary.

For I-VSD, this means that dependency governance is not only a compliance checklist. It includes pinning or verifying security-sensitive build inputs where practical, limiting token scope, making secrets rotatable, reviewing automated updates before they reach sensitive paths, documenting known gaps, and asking what would happen if source code, CI logs, or dependency behavior became visible to an adversary. The ethical aim is designed security: systems should limit the blast radius of a defect or compromise rather than merely trying to patch faster after harm becomes public.

Protocol choices can also become supply-chain and dependency choices. ATProto-oriented infrastructure may reduce dependence on a single application provider by making identity, records, and interoperability more portable across applications. At the same time, it introduces new dependencies on protocol stability, PDS operators, OAuth scopes, record schemas, moderation practice, and the health of the surrounding ecosystem. I-VSD should therefore treat integration-native infrastructure as an ethical opportunity and an operational responsibility: it can reduce API gatekeeping and provider lock-in only if the resulting dependencies are documented, tested, and governed honestly.
...
Recent developments suggest growing consumer awareness of unethical technology practices. The "Clippy Movement" of 2025, initiated by consumer rights activist Louis Rossmann, encouraged users to adopt the Microsoft Clippy mascot as a profile picture to protest data exploitation, enshittification, and loss of software ownership. The choice of Clippy was symbolic: unlike many contemporary AI systems, Clippy did not mine user data, sell information to advertisers, or require subscriptions for basic functionality.

The movement's slogan, "Clippy just wanted to help," captured the contrast between user-serving and user-exploiting design philosophies. Critics could dismiss the action as "slacktivism," but its visibility still helped connect ordinary software frustration with political issues such as DMCA Section 1201 reform. At minimum, it suggests that some users are dissatisfied with current industry practices and are looking for symbols and language to express that dissatisfaction.

This awareness creates an opening for I-VSD-aligned services, but not a guaranteed market. Organizations that can credibly explain their ethical practices may reach users seeking alternatives to exploitative platforms. The framework provides operational guidance for services built around explicit ethical commitments and a principled basis for communicating those commitments honestly.
...
Collective action should therefore include escalation discipline. Users, customers, and organizations should normally raise correctable problems through official support, security disclosure, complaint, or governance channels before attempting to damage public reputation. This is especially important when the facts are incomplete or the harm may be caused by error rather than malice. However, direct contact is not an absolute requirement: public documentation, regulator complaints, migration campaigns, or community warnings may be necessary when harms are urgent, repeated, hidden from affected users, or ignored by the provider.

Consumer awareness also includes vocabulary. Users often inherit the language of dominant platforms, including words that frame independent installation, self-hosting, repair, export, or alternative distribution as marginal or suspicious. I-VSD-aware criticism should therefore examine whether a term describes a real safety concern or subtly shifts legitimacy toward the incumbent provider. This does not mean dismissing all security warnings; it means asking who defines the default, who benefits from that definition, and whether users are given enough information to choose responsibly.

#### 5.4.12 Inherent Abstraction and Context Dependency

One limitation of this thesis, distinct from limitations of I-VSD itself, is its level of abstraction. Software includes enterprise systems, mobile applications, embedded software, web services, databases, cloud infrastructure, payment processing, and many specialized domains. Each category has its own ethical questions, vendor landscape, and technical constraints.
...
The ISLAMU Event case study illustrates I-VSD in one specific context: a nonprofit organization developing a federated event platform. This provides concrete illustration, but most readers will operate in different contexts, including for-profit enterprises, other industries, different organizational roles, or different religious and secular orientations.
...
These limitations are part of the framework's intended scope. A framework abstract enough to apply across settings necessarily sacrifices some specificity. I-VSD provides principles and heuristics; practitioners must still apply judgment to their circumstances. The case study illustrates one application path, not proof that implementation is easy or that every situation has a clear answer.

This context dependency is especially visible in sector-specific design decisions. A transparency preference that is appropriate for one project may require qualification in another. For example, open standards, open source, and public documentation can support accountability and user freedom, but high-risk sectors may also require controlled disclosure, coordinated vulnerability handling, restricted operational details, or formal assurance processes. The relevant ethical question is not whether openness or restriction wins in the abstract, but whether the chosen balance protects users from foreseeable harm while remaining honest about what is hidden, reviewed, auditable, and accountable.

The same limitation applies to file formats and protocols. I-VSD can prefer standard, documented, and portable formats because they reduce lock-in and make user control more realistic. But a new domain or novel feature may sometimes require a custom format because no existing standard can represent the needed data or behavior responsibly. In that case, the ethical requirement shifts from "never create a new format" to "make the exception accountable": document why the exception exists, minimize unnecessary lock-in, provide conversion or export paths where possible, and revisit the decision when mature standards become available.

#### 5.4.13 Decision Cost Reduction and Cognitive Liberation

Every significant design decision carries costs in time, focus, and optionality. Time costs are visible in the hours spent researching, deliberating, and deciding. Focus costs are less visible because unresolved choices continue to occupy attention. Optionality costs arise when commitment to one path closes other paths.
...
This reduction in decision burden can produce a kind of practical freedom. Researchers note that "having infinite options sounds appealing in theory, but in practice it becomes paralyzing." I-VSD removes options that violate its principles, reducing the decision space to more manageable dimensions. This is disciplined constraint rather than unrestricted freedom: the provider is spared from treating every recurring ethical question as an entirely new problem, while still needing judgment in hard cases.

#### 5.4.14 Strategic Focus Through Principled Limitation

Military strategists observe that "he who tries to protect everything protects nothing." A similar problem appears in software development when a provider tries to optimize simultaneously for revenue, engagement, virality, user welfare, and ethical compliance. Some objectives conflict, and pursuing all of them without hierarchy can prevent coherent decision-making.

I-VSD provides strategic focus by establishing non-negotiable priorities. When ethical compliance is mandatory rather than optional, optimization must occur within the remaining permissible space. This can concentrate effort in chosen areas rather than spreading effort across conflicting objectives.

Practitioners must accept this tradeoff consciously. Applying I-VSD may mean slower growth than competitors who exploit users, smaller addressable markets than platforms willing to compromise, or short-term vulnerability in exchange for principled focus. The benefit is clarity: instead of repeatedly renegotiating between ethics and expedience, the framework requires the provider to resolve that conflict in favor of principle.

#### 5.4.15 Progressive Adoption and Incremental Transformation

I-VSD does not require instantaneous transformation. Software organizations can adopt the framework progressively, applying its principles to new decisions while maintaining existing systems. This makes the framework more practical for organizations that cannot redesign everything at once.

Progressive adoption can proceed along several dimensions. New dependencies and architectural decisions can use I-VSD evaluation while legacy components remain temporarily unchanged. The most serious violations can be addressed first while less urgent issues wait for resources. Business-model transformation can occur incrementally as sustainable alternatives become viable.

Software can sometimes accommodate such transformation more easily than physical industries, although not without cost. Names, logos, business models, technologies, dependencies, interfaces, and terms of service can all evolve. The Ghostty Terminal's adoption of a nonprofit funding model shows that even significant organizational changes are possible.

This flexibility means that readers do not face only a binary choice between complete implementation and complete rejection. The framework can guide partial adoption, with deeper benefit as review practices, business decisions, and technical systems become more consistent with its principles.
...
One difficult aspect of value-driven development is maintaining intention over time. Intentions can change, and organizations that began with genuine commitment to user welfare can drift into exploitation. The challenge is not only making ethical choices initially, but sustaining that commitment across years, leadership changes, and competitive pressures.
...
The practical implications are significant. Marketing oneself as ethical creates elevated expectations. Users who trust an ethical commitment may be more harmed by betrayal than users who never relied on such a promise. A serious contradiction between public commitments and later conduct can undermine years of reputation-building. Firefox's 2025 Terms of Use and Privacy Notice controversy illustrates this risk in a narrow way: users reacted strongly to broad license and data-use wording, and Mozilla later revised the language and clarified that it did not intend to claim ownership of user content or sell data in the ordinary sense. Even if the change was a legal-communication failure rather than malicious conduct, the incident shows how quickly trust built around privacy and public-interest identity can weaken when users cannot reconcile new policy language with earlier promises.
...
Competitive pressure tests intention in a particularly subtle way. A provider may begin with sincere concern for user benefit but later feel joy at a competitor's failure, resentment at a competitor's success, or eagerness to exploit another provider's mistake for reputational gain. I-VSD treats this as an intention-maintenance problem, not merely a marketing problem: the provider must still want good for users, avoid unjust hostility, and compete through better service rather than schadenfreude or predatory opportunism.

#### 5.4.18 The Long Game: Patience, Trust, and Divine Wisdom

Value-driven development can appear disadvantaged in the short term. Ethical competitors may grow more slowly than organizations willing to exploit users. Monthly metrics may reward expedience over principle, even when the principled path is more sustainable over time.
...
For I-VSD practitioners, this means accepting that immediate results may not validate ethical choices. Vindication may come later, or may not be visible in worldly terms at all. This requires an orientation that conventional business metrics do not fully capture.

Three observations support patience. First, sustainable practices may accumulate trust and resilience over time even when early growth is slower. Second, trust built through consistent conduct can become difficult for exploitative competitors to imitate. Third, and most fundamentally, divine accounting differs from quarterly reporting. God can bring outcomes through means, against apparent means, or without visible means.
...
The framework offers a structured approach to ethical software development, but practical implementation still depends on practitioner agency. It is useful to distinguish between two impediments to adoption: **structural constraints** and **volitional rationalizations**.

Legitimate structural constraints exist. Divergent ethical philosophies, lack of organizational authority, or rigid employment hierarchies may genuinely limit a practitioner's ability to influence architectural decisions. In such cases, non-adoption is a consequence of circumstance rather than intent.

The analysis changes when constraints are internal rather than external. If refusal to implement ethical safeguards is justified mainly by competitive pressure, fear of slower growth, or organizational inertia, then the issue may be choice rather than incapacity. A persistent gap between espoused values and professional action reveals a failure of moral agency that the framework cannot solve by methodology alone.

This phenomenon resembles the psychological concept of **existential cowardice**, understood as dissonance between one's values and one's actual behavior. As noted in psychological literature, this state can arise when individuals fail to act on their "hopes and dreams" because of fear. In this thesis, the point is not to condemn external actors from a distance, but to require introspection from practitioners who already recognize the ethical problem.

An ethical framework can provide method, vocabulary, and review structure, but it cannot supply the courage to apply them. Where structural power exists, refusing to use it in accordance with one's principles is not only a strategic calculation; it is an ethical responsibility left unmet.

Moral agency also appears in competitive response. When another provider succeeds, fails, or suffers a public mistake, the I-VSD practitioner still chooses how to respond. The framework cannot prevent envy, resentment, or opportunistic customer capture by method alone. It can only make the question visible: is the provider acting from sincere service and concern for users, or from a desire to see a competitor humiliated and displaced regardless of what benefits the affected users?

The same agency applies when giving feedback about another service. A practitioner may notice a real flaw, bad experience, or harmful pattern, but still choose whether to seek correction through responsible channels or to maximize reputational damage. I-VSD does not demand silence in the face of harm, but it treats escalation as a moral act: the provider should ask whether public criticism is needed to protect users and truth, or whether direct feedback would correct the issue without unnecessary injury.

#### 5.4.21 Protecting One's Soul in Business

A final benefit of I-VSD is protection against gradual moral compromise in pursuit of business success. The observation that "you only optimize for what you track" suggests that without explicit ethical tracking, optimization will default to financial metrics.

The phrase "selling your soul to your business" captures this danger. When professional practice requires continuous ethical compromise, the work may succeed by conventional metrics while weakening the practitioner's integrity.

I-VSD responds by making ethical commitments explicit and reviewable. When ethical responsibility is tracked alongside financial performance, optimization cannot ignore it as easily. The framework can help practitioners build businesses without separating professional success from the values that give the work moral meaning.

This protection includes the inner posture of competition. A provider can avoid obvious dark patterns while still allowing envy, resentment, or obsession with a rival's losses to shape decisions. Wanting users to be protected from harm is different from wanting a competitor to be harmed. I-VSD therefore asks practitioners to review not only public behavior but also the incentives and emotions they reward internally: do metrics, meetings, and marketing encourage better service, or do they cultivate satisfaction at another party's downfall?

This is one of the framework's deeper contributions: not only shaping software outcomes, but helping providers protect their own moral integrity while building them.
...
A recurring tension in software design is the distinction between what users want immediately and what genuinely serves their interests. User-experience optimization often targets satisfaction: reducing friction, increasing comfort, and making the product feel pleasant to use. Yet satisfaction can diverge from welfare, and I-VSD requires providers to consider the latter even when it conflicts with the former.

Security provides a clear illustration. Sensitive information such as passwords, credit card numbers, and personal identifiers should generally be hidden by default, with explicit user action required to reveal it. Fixed-length masking can also avoid revealing password length. These choices reduce exposure to screen recording, over-the-shoulder observation, shared-space cameras, screen-sharing accidents, and other ordinary disclosure risks.
...
I-VSD rejects this logic. Users do not always know what serves their genuine interest in a technical or security context. Behavioral psychology research on defaults, including Johnson and Goldstein's organ-donation default study, shows that many people accept default choices rather than actively changing them. When platforms set harmful defaults such as opted-in data sharing, visible sensitive information, or pre-selected marketing consent, they exploit this pattern to extract value from user inattention rather than informed consent.
...
This principle extends beyond security to other design decisions involving user welfare. Cookie consent should default to minimal collection, not maximum tracking. Marketing communications should require opt-in, not opt-out. Privacy settings should default to restrictive, not permissive. Subscription renewals should require confirmation, not silent auto-continuation. In each case, design guided by I-VSD prioritizes the user's genuine interest even when a more convenient option might be more satisfying in the short term.

The practical implication is significant: software guided by I-VSD may receive lower user satisfaction scores than competitors that optimize for pleasure over protection. This is a deliberate tradeoff. Designing for user interest rather than immediate satisfaction may cost market share, but it better preserves user welfare and provider integrity.
...
The same distinction applies to marketing and pricing language. A user may feel satisfied by warm community language such as "support the developer," "become a supporter," or "help keep the project alive," but in a paid SaaS checkout this can blur the line between commerce and charity. If the user is buying access, features, hosting, or support, the interface should make that transaction clear. Honest sustainability language is permissible; emotional pressure attached to a purchase exploits user goodwill rather than serving user interest.

Compliance language can create a similar default impression. Phrases such as "GDPR-friendly," "SOC 2-ready," or "enterprise-grade" may lead users to assume a level of audit, legal review, or operational maturity that has not actually been achieved. I-VSD therefore treats vague trust language as a default-setting problem: when the provider leaves ambiguity in place, many users will accept the stronger interpretation. Truthfulness requires making the evidence boundary explicit.

### 5.5 Anticipated Objections and Responses

This section considers objections that could be raised against I-VSD and responds by clarifying the framework's scope, evidence level, and practical limits.
...
**Response:** This objection matters, but it should be located at the framework's actual scope. I-VSD guides providers that explicitly adopt Islamic principles; it is not a universal requirement for all software development. Users encounter those services as they encounter any service shaped by a particular design philosophy, business model, or governance structure.

Moreover, many I-VSD principles address practices that users of any background may reasonably prefer to avoid: deception, privacy violations, manipulation, and exploitation. The Islamic grounding supplies the provider's normative basis and motivation; the resulting practices can still serve users regardless of their personal religious commitments. A user need not be Muslim to prefer honest marketing, transparent pricing, and secure data handling.

The framework therefore should not be read as mandating Islamic religious practice through software. It requires providers who adopt it to act truthfully, transparently, and responsibly. Users can benefit from those practices without conversion or religious agreement.
...
**Response:** This objection correctly identifies genuine diversity within Islamic scholarship. The response is not to deny that diversity, but to distinguish between broad principles and contested applications.

I-VSD begins from principles that enjoy broad recognition in Islamic moral reasoning, such as prohibitions against deception, requirements of trustworthiness and fair dealing, and the obligation to fulfill promises. Where legitimate scholarly disagreement exists, the framework should acknowledge it rather than claim false certainty.

For contested issues, I-VSD provides a structure for analysis while acknowledging that different organizations may reach different conclusions based on their chosen scholarly authorities. An organization following one school of jurisprudence may make different specific decisions than one following another, while both may still remain within the bounds of legitimate Islamic reasoning.

The existence of internal debate does not invalidate the framework; it requires careful language about certainty levels, authority, and scope. I-VSD should therefore make those distinctions explicit.
...
The objection becomes stronger in markets where acquisition or investor pressure rewards extraction after user dependence has formed. If a competitor can accept aggressive capital, grow quickly, and later monetize lock-in more intensely, an I-VSD-aligned provider may look slower or less optimized. This is a real strategic constraint, not something the framework should hide. The response is not to deny the pressure, but to make the tradeoff explicit: some forms of capital efficiency may be unavailable if they depend on future degradation, opaque ownership changes, or user dependence.

Second, even if the objection were partly correct, it would not remove the framework's normative relevance. I-VSD does not guarantee worldly success. It provides principled guidance for providers who prioritize ethical compliance over unrestricted business optimization. The framework should not be presented as a guarantee of market success. Its narrower claim is that selected Islamic principles can structure morally accountable software decisions even when the market outcome remains uncertain.
...
Abstract principles are translated into specific heuristics throughout Chapter 3 and the appendices. A developer need not understand the full jurisprudential derivation of privacy requirements to apply the heuristic "collect only data necessary for stated functionality." The heuristics provide guidance derived from principles, while reducing the need to repeat principle-level reasoning for every decision.

However, the objection correctly identifies that more work is needed. Tooling, checklists, training materials, and community resources would make I-VSD more accessible. This is a direction for future development rather than a reason to reject the framework at the conceptual stage.

Organizations adopting I-VSD should invest in training and, where possible, engage practitioners with relevant expertise. The framework does not claim that any developer can apply it without preparation; it claims that prepared practitioners can use it as a structured review and design aid.
...
**Response:** Secular frameworks provide valuable guidance, and I-VSD does not claim that they are useless. For practitioners without religious commitments, secular frameworks may be sufficient.

For Muslim practitioners, however, secular frameworks may leave important questions unanswered. They do not necessarily connect professional practice to spiritual accountability, resolve tensions between faith-based ethics and industry norms, or supply the motivational force that religious commitment can provide.

The question "why should I be ethical when exploitation is profitable?" has a distinct Islamic answer: because God commands justice and trustworthiness, because the Prophet exemplified them, and because eternal accountability outweighs temporary gain. Secular frameworks may answer this question differently, but I-VSD makes the religious answer explicit for practitioners who accept it.

Furthermore, Islamic foundations provide a principled basis for decisions that some secular processes may leave to stakeholder negotiation. If stakeholders prefer manipulation because it increases engagement metrics, a framework grounded only in negotiated preference may struggle to resist that pressure. I-VSD instead treats some ethical limits as non-negotiable for providers who accept the Islamic commitments on which it is based.

I-VSD is therefore not proposed as a replacement for secular frameworks, but as a complementary framework for practitioners whose deepest commitments are religious.
...
This limitation reflects the scope constraints of a bachelor thesis rather than a reason to dismiss the framework outright. The positionality should be disclosed rather than hidden: founder involvement can make design reasoning and motivation visible, but it also creates risks of self-justification, founder optimism, and marketing bias. Stronger future evidence would require independent practitioner use, multiple case studies, stakeholder evaluation, comparative analysis, audits, and longitudinal observation.

At the same time, having no case at all would create a different weakness. If the thesis only described what a moral software provider should do in the future, it would be harder to judge whether the framework can survive contact with concrete product, architecture, funding, governance, and maintenance choices. The ISLAMU Event case therefore provides a modest but meaningful plausibility signal: it shows one implementation attempt where the author had to make decisions rather than only state ideals.
...
Current implementation evidence reduces one weakness of a single case: the reader can inspect more than a proposal or aspiration. It does not remove the deeper limitation that the case remains one self-applied project without independent adoption, user studies, external audits, or longitudinal operational evidence.
...
The same point applies to technical process choices that may appear purely professional. Whether a system should be open source, closed source, independently audited, rapidly prototyped, AI-assisted, or manually reviewed cannot be answered apart from sector, risk, and foreseeable harm. A prototype for an informal community tool and a production banking or health system do not carry the same duties. Treating both as morally identical because they are both "software" hides the value judgment already being made about risk, responsibility, and user trust.

Even apparently narrow architecture choices, such as whether to use an existing standard format or create a new proprietary format, contain value judgments. Choosing a standard can express respect for user portability and ecosystem cooperation; choosing a new format can be justified when the technical requirement is genuinely new. The moral issue is whether the provider documents the tradeoff and reduces avoidable dependence, not whether every context receives the same technical answer.
...
This chapter answers the main research question, states the thesis contribution, and identifies the future work needed before stronger validation claims could be made.

The conclusion preserves the evidence boundary used throughout the thesis: I-VSD is a constructive framework for design reasoning, illustrated through ISLAMU Event as one implementation-traceability case. It is not an automated religious-legal opinion mechanism, product certification, or completed empirical validation of ethical outcomes.

### Final Contribution and Claim Boundaries

The thesis's final contribution is the I-VSD framework itself: a reusable way to translate selected Sunni Islamic ethical principles into provider-facing software design heuristics, evidence categories, and review questions. ISLAMU Event shows how the framework can organize design and implementation reasoning in one bounded case.

The current evidence supports conceptual coherence, design traceability, and illustrative application. It does not establish independent practitioner acceptance, contemporary Islamic scholarly validation, positive stakeholder experience, or operational effectiveness through deployment data. Those stronger claims require the future validation agenda developed in the recommendations: scholar review, practitioner review, stakeholder interviews and surveys, accessibility/privacy/security audits, additional cases, and longitudinal operational study.

This distinction is central to the thesis answer. I-VSD can help a provider reason more explicitly about software responsibility, but it requires further evaluation before it can be treated as a validated method across software domains or organizational contexts.

### Refined Contribution Statement

The thesis contribution is not that I-VSD replaces existing value-conscious design, policy, or engineering methods. Its contribution is a scoped integration: selected Sunni Islamic ethical principles provide the normative specification layer; VSD and adjacent design traditions provide sensitivity to stakeholders, values, and lived effects; Value-based Engineering and formalization tools show how values may become requirements, metrics, controls, and traceability artifacts; governance instruments such as AI RMF, AIA, UNESCO, OECD, the EU AI Act, and the Council of Europe AI Convention provide audit and lifecycle vocabulary; and the ISLAMU Event case gives a bounded worked application.

| Contribution dimension | What this thesis contributes | What it does not claim |
| --- | --- | --- |
| Relative to standard VSD | A religiously grounded provider-responsibility specification for software contexts where stakeholder preference alone is not enough. | It does not claim that standard VSD is obsolete or morally empty. |
| Relative to neighboring design frameworks | A comparison point for Capability Sensitive Design, care-centered VSD, VBE/IEEE 7000, RRI, and governance-oriented methods. | It does not claim to replace these frameworks or absorb their full literatures. |
| Relative to engineering formalization | A formalization-ready path from principles to requirements, metrics, controls, evidence, and future validation. | It does not claim that the framework has already been mathematically formalized or empirically validated. |
| Relative to governance policy | A way to use policy instruments as audit, documentation, and lifecycle-review support. | It does not treat legal compliance, risk management, or standards alignment as Islamic moral certification. |
| Relative to Islamic ethics | A software-focused translation of selected principles within a declared Sunni scope. | It does not issue fatwas, settle contested jurisprudential questions, or certify products as Sharia-compliant. |

### Future Publication Path

The thesis can support later publication work, but those outputs remain future research tasks rather than completed publications.

| Possible output | Core question | Possible venue family | Required strengthening before submission |
| --- | --- | --- | --- |
| Conceptual framework paper | How can selected Islamic ethical principles be translated into a provider-responsibility framework for software? | Ethics and Information Technology, Science and Engineering Ethics, AI & Society | Tighter literature review, clearer source selection, and external scholarly feedback. |
| Formalization paper | How can I-VSD values be translated into requirements, controls, metrics, and traceability artifacts? | Software engineering ethics venues, FAccT, AIES, Data & Policy | Formal examples, reproducibility package, reviewer-tested rubrics, and limits of automation. |
| Case-study governance paper | How does ISLAMU Event function as a worked governance and audit testbed? | CHI, CSCW, Data & Policy, applied software-engineering venues | Independent practitioner review, stakeholder evidence, operational records, and comparative cases. |
| HCI/design paper | How do affected users understand trust, transparency, accessibility, recourse, and Islamic ethical design cues? | CHI, CSCW, HCI and responsible-design venues | Interviews, surveys, usability studies, accessibility checks, and careful inclusion of Muslim and non-Muslim affected stakeholders. |

### Hostile-Examiner Coherence Check

The final thesis should withstand critical examination by keeping the following boundaries visible:

| Examiner concern | Final coherence response |
| --- | --- |
| VSD strawman risk | The thesis treats VSD as a foundational design tradition and uses critiques to motivate I-VSD's specific religious-normative layer, not to dismiss VSD. |
| Islamic authority overreach | The framework uses selected principles within a declared scope and repeatedly reserves contested rulings for qualified scholarly review. |
| Formalization theater | Formal models, metrics, and audit artifacts are presented as future or partial supports, not as proof that moral judgment has been automated. |
| Empirical overclaiming | ISLAMU Event is a worked, self-applied case and implementation-traceability artifact; stakeholder, scholar, practitioner, and operational validation remain future work. |
| Policy compliance confusion | Governance instruments support documentation, risk assessment, and auditability, but they do not replace Islamic normativity or guarantee ethical adequacy. |
| Thesis bloat | The central contribution remains narrow: a constructive I-VSD framework for provider-mediated software, illustrated once and prepared for future validation. |
...
This thesis answers by proposing I-VSD as a constructive Islamic provider-responsibility framework. It translates selected Sunni Islamic ethical principles into design heuristics, maps them across strategic, design, technical, operational, governance, and evaluation domains, and applies them to ISLAMU Event as one illustrative case. Because the case is self-applied by Amir as founder of ISLAMU and solo developer of ISLAMU Event, it functions as transparent implementation-traceability evidence and a worked application, not as complete empirical support or independent validation.

#### 6.1.1 Establishes an Islamic Provider-Responsibility Framework

I-VSD establishes a provider-responsibility structure by combining three elements:
- **Selected Islamic principles** from the Quran, Sunnah, and scholarly tradition, including trust, proper conduct, justice, truthfulness, prohibition of deception, and related duties
- **Design-sensitivity practices** that translate moral commitments into concrete software decisions
- **Compatible industry practices** used as operational support while explicitly avoiding documented anti-patterns

This structure produces a framework that is:
...
The framework turns abstract principles into reviewable provider responsibilities across domains:

**Strategic Domain:**
- Organizational structure oriented toward community service
- Funding sources that avoid interest/usury-based capital
- Partnership ethics and values-alignment review

**Technical Domain:**
- Architecture that supports openness, self-hosting, and reduced vendor lock-in
- Data governance that minimizes collection and increases user control
- Security duties such as encryption, proper password hashing, and prompt vulnerability patching

**Design Domain:**
- Interface design that avoids dark patterns and makes pricing, defaults, and free tiers transparent
- Content moderation standards that are consistent, documented, and values-based
- Accessibility and localization requirements that require testing rather than assumption

**Operational Domain:**
- Marketing based on truthful claims and respectful communication
- Support practices that are responsive and accountable
- Maintenance commitments that are bounded by realistic capacity and honored promises
...
- **Centering religious moral commitments** rather than treating them only as private preferences
- **Identifying non-negotiable ethical boundaries** from the selected Islamic sources used in this thesis
- **Extending design ethics to business-model questions** such as funding, organizational form, revenue, and partnership choices
- **Offering community-specific guidance** for Muslim software developers and organizations without claiming to replace scholarly legal judgment
...
The recommendations distinguish immediate practitioner use from future validation. Practitioners can use I-VSD as a review and traceability framework now, while stronger claims about effectiveness, scholarly acceptance, stakeholder experience, and operational outcomes require further study.
...
- Record tradeoffs, evidence levels, and unresolved risks
...
Develop I-VSD into reviewable research instruments:
...
Track I-VSD applications over time, especially where design intentions must be tested against lived operation:
...
Develop contemporary scholarly guidance on:
- Emerging technologies such as AI, blockchain, and IoT
- Data privacy from an Islamic perspective
...
Clarify how Islamic legal principles should be applied to software contexts:
- Analogical reasoning for new technologies
...
Such review would strengthen confidence in the framework's theological and Islamic grounding, but it should still be described carefully: it would not automatically certify every future software product that applies I-VSD.
...
Create educational materials that connect Islamic ethics to concrete software decisions:
- Islamic ethics in computer science
- I-VSD framework use and application
...
Integrate I-VSD into existing programs where ethics, design, and software responsibility are already taught:
...
- Prioritize software choices that are transparent, fair, and respectful of Islamic values
- Support Muslim-developed ethical alternatives when they are responsibly maintained
- Provide concrete feedback to developers
- Sustain ethical projects through donations, subscriptions, or other appropriate support

**Community Action 2: Demand Accountability**
Hold organizations accountable in proportionate and constructive ways:
- Question harmful or deceptive practices
- Leave unethical services when credible ethical alternatives exist
- Advocate for Islamic values in technology without ignoring evidence, expertise, or practical constraints
...
- Provide technical, design, content, governance, or community expertise
...
**Enhancement 3: Tool Development and Evaluation**

Develop and evaluate practical tools such as:
...
The existing `i-vsd` agentic skill should be treated as an initial artifact within this tool-development direction rather than as completed validation. Future thesis work should version the skill, compare it with checklist-only and non-I-VSD review baselines, test whether practitioners can apply its report contracts consistently, and examine where its action routing fails or requires human, scholarly, legal, security, accessibility, or stakeholder escalation.

A future evaluation program should test the skill as a reusable host-repository artifact, not only as a prompt. The relevant question is whether different capable agents and practitioners can load the same skill folder, follow the same scope boundaries, inspect comparable evidence, and produce reports with consistent claim boundaries. Such evaluation should include both successful routing and intentional refusal cases, because refusing unrelated requests, generic software help, or religious-legal authority questions is part of the artifact's ethical design.

**Future direction: Assay-backed I-VSD governance gates**

A particularly important future direction is to connect the `i-vsd` agentic skill to an enforcement ecosystem such as Assay. The present skill is useful for individual or practitioner-led review because it can guide an AI agent through context discovery, moral-diff assessment, evidence recording, and bounded reporting. However, by itself it remains a review artifact. It can produce a report, but it does not automatically stop a risky change from being committed, merged, or deployed. This is a major difference between an I-VSD review assistant and an operational governance gate.

The Assay Ecosystem suggests a stronger architecture for this future work: a hybrid deterministic-agentic governance layer. In such a layer, the I-VSD skill would remain the semantic interpretation component. It would read the git diff, commit metadata, branch context, relevant repository documentation, and I-VSD framework resources. It would then classify findings into structured categories such as hard violations and soft warnings. Assay would provide the deterministic enforcement component. It would capture the run, ingest structured telemetry, preserve evidence, apply a policy file, count the number and severity of findings, and return an ordinary pass or fail exit code to the surrounding development workflow.

This division of labor directly addresses a weakness in using AI review alone. An LLM can be useful for interpreting intent, recognizing deception risks, noticing hidden telemetry, identifying manipulative interface changes, or comparing a code diff with prior documentation promises. Those are semantic tasks. The same LLM should not be trusted as the final authority for threshold arithmetic, pipeline exit behavior, or evidence-retention guarantees. If the policy says that any `CRITICAL` issue blocks the pipeline, or that more than two `WARNING` findings fail the gate, that decision should be made by deterministic tooling rather than by another paragraph of model reasoning. The agent should classify; the gate should enforce.

![figure assay backed i vsd governance gate](../30-Resources/Thesis/figure_assay-backed-i-vsd-governance-gate.png)

**Alt text/textual equivalent:** Three-layer diagram showing `i-vsd` reading repository changes and producing structured findings, Assay preserving telemetry and evidence, and a deterministic policy gate applying thresholds to produce pass/fail workflow outcomes.

For I-VSD, this distinction is ethically important. The framework repeatedly warns against formalization theater: a tool should not pretend that completing a template proves moral compliance. An Assay-backed gate would not solve that problem by certifying a product as Islamic, Sharia-compliant, or ethically complete. Instead, it would make a narrower and more useful claim: for this run, against this declared policy, with this captured diff and metadata, the repository either did or did not cross the configured I-VSD review threshold. That is still only a workflow judgment, but it is a much stronger operational judgment than a non-binding Markdown report.

The future architecture could be expressed in three layers:

| Layer | I-VSD role | Assay role | Boundary |
| --- | --- | --- | --- |
| Agent evaluation layer | Load the `i-vsd` skill, inspect the repository change, read commit and branch metadata, and produce structured findings. | Capture the agent run and receive structured output or telemetry. | The agent supports moral review, but does not become a religious authority or final certification body. |
| Protocol audit layer | Preserve the evidence needed to understand why the finding was made: diff, context, missing evidence, escalation notes, and report output. | Ingest OpenTelemetry-style traces, execution logs, prompt/output records, and evidence bundles. | Evidence capture improves auditability, but does not prove the finding is correct without human and scholarly review where needed. |
| Pipeline enforcement layer | Define which finding categories matter for local, pull-request, and deployment contexts. | Apply deterministic `policy.yaml` rules, count hard and soft violations, and return pass/fail exit codes. | A failed gate means the configured governance policy was violated; it does not by itself settle every moral or legal question. |

In practical terms, future work could adapt the I-VSD skill so that its moral-diff review action emits a strict machine-readable output. For example, the report could include a YAML block with `assessment.pass`, a list of findings, a severity field, affected files or lines, evidence reviewed, missing evidence, and escalation requirements. The language model would be constrained to a narrow output contract. Assay would then match the resulting fields against a policy file. A `CRITICAL` finding could represent a hard breach: hidden telemetry, deceptive copy, unjustified removal of promised data export, security backdoor behavior, dark-pattern pricing, or privacy-invasive permission expansion. A `WARNING` finding could represent a softer but still review-worthy concern: ambiguous documentation, incomplete evidence, unclear user communication, missing accessibility follow-up, or a change that weakens a previous governance baseline without immediate severe harm.

A future policy file could therefore translate I-VSD categories into pipeline behavior. The most direct rule would be `fail_on_errors: true`, so any hard violation blocks the action. A second rule could define `max_allowed_warnings`, so an isolated soft warning remains visible but does not necessarily stop development, while repeated ambiguity or unresolved governance debt eventually becomes blocking. This is useful because I-VSD does not treat all ethical concerns as identical. Some actions are red-line violations. Others are early signals that the provider must clarify, document, or review the decision before risk accumulates. A deterministic gate can respect this distinction better than an informal review comment that developers may ignore.

![figure hard soft violation treshold logic](../30-Resources/Thesis/figure_hard-soft-violation-treshold-logic.png)

**Alt text/textual equivalent:** Flowchart showing structured I-VSD findings moving through a deterministic policy gate where any critical finding fails the workflow, warnings are counted against a configured threshold, and passing with warnings still preserves visible evidence.

This future system could operate across the whole development lifecycle rather than only inside a single AI chat session. In a local workspace, a pre-commit hook could run the I-VSD moral-diff evaluator against staged changes and block the commit if the policy threshold is crossed. In pull-request review, a GitHub Actions workflow or Forgejo/Codeberg action could run the same evaluator on the PR diff, publish a job summary, attach evidence artifacts, and mark the check as passing or failing. In production CI/CD, the gate could become stricter for protected branches such as `main` or `release/*`, where a critical privacy, truthfulness, security, or promise-keeping violation should stop deployment rather than merely create a comment. The same architecture could also be adapted to decentralized or self-hosted Git workflows if the Assay CLI and policy files remain portable.

![figure local to cli lifecyle enforcement path](../30-Resources/Thesis/figure_local-to-cli-lifecyle-enforcement-path.png)

**Alt text/textual equivalent:** Lifecycle diagram showing staged repository changes passing through local pre-commit, pull-request, and production deployment gates, with each gate running I-VSD moral-diff evaluation, capturing Assay evidence, applying policy, and producing pass/fail outcomes.

This would extend the current thesis artifact in a concrete way. At present, the `i-vsd` skill can support an individual reviewer who asks for an implementation review or a moral-diff assessment. That is valuable, but it depends on the reviewer deciding to run the skill and then deciding to act on the result. An Assay-backed integration would make the review part of the repository's governance boundary. The skill would no longer be only a helpful assistant; it would become one component in a repeatable compliance loop. Developers would receive feedback at the point where their actions matter: before commit, during pull-request review, and before deployment.

Several design requirements follow from the I-VSD claim boundaries in this thesis. First, the gate should be configurable by repository and risk context. A community event platform, a finance-related system, a healthcare tool, and a public-sector decision system should not use identical thresholds without justification. Second, the gate should preserve human-in-the-loop escalation. If the agent identifies a contested Islamic finance question, a high-stakes privacy issue, a legal compliance uncertainty, or a possible public-harm scenario, the correct behavior may be to block pending expert review rather than to claim the AI resolved it. Third, the system should preserve evidence bundles for later audit. A future maintainer should be able to see the exact diff, metadata, policy, model output, and threshold decision that produced a block or pass. Fourth, the workflow should avoid hidden surveillance of developers. Captured telemetry should be proportionate, documented, access-controlled, and scoped to governance evidence rather than becoming another unreviewed monitoring system.

![figure evidence bundle and audit trail](../30-Resources/Thesis/figure_evidence-bundle-and-audit-trail.png)

**Alt text/textual equivalent:** Evidence-bundle diagram showing Assay collecting diff, metadata, context, skill and policy versions, agent output, telemetry, missing-evidence records, escalation records, and pass/fail decisions for later inspection by maintainers, reviewers, scholars, legal or privacy experts, and researchers.

The research value of this proposal is that it creates testable questions. Future studies could compare ordinary AI code review, checklist-only I-VSD review, the current `i-vsd` skill, and an Assay-backed deterministic gate. Researchers could measure whether the gate improves issue detection, evidence completeness, consistency between reviewers, response to hard violations, and preservation of claim boundaries. They could also test failure modes: false positives, false negatives, over-blocking, model inconsistency, prompt injection against the review agent, missing context, developer attempts to game commit messages, and cases where a soft warning should have been escalated. These tests would not prove that the system is morally complete, but they would provide stronger artifact-evaluation evidence than an unintegrated prompt or isolated report.

The most important thesis contribution of this future direction is therefore not automation for its own sake. It is the operationalization of accountability. I-VSD argues that software providers should make ethical responsibilities inspectable, traceable, and revisable. A future Assay-backed I-VSD gate would turn that argument into infrastructure: ethical review becomes part of the same engineering path as tests, builds, security scanning, and deployment policy. The moral reasoning would remain bounded, revisable, and subject to human and scholarly review; the enforcement mechanics would become deterministic, auditable, and harder to ignore.

| Future evaluation target | Possible protocol | Boundary |
| --- | --- | --- |
| Host-repository adoption | Install or adapt the skill in several provider-mediated software repositories and observe whether agents can locate resources, create the expected `islamic-value-sensitive-design/i-vsd-*.md` reports, and preserve existing review history. | Adoption evidence would show portability mechanics, not universal applicability to every repository. |
| Agent-independent use | Ask different AI agents or host environments to perform the same routed actions against shared evidence bundles. Compare action selection, evidence reviewed, missing-evidence logs, findings, and escalation language. | Consistency testing would evaluate process reliability, not prove that the moral judgement is final. |
| Refusal and narrowing behavior | Present unrelated, adjacent-but-out-of-framework, mixed, and religious-legal authority requests. Check whether the agent refuses, narrows, or escalates as specified. | Correct refusal protects the framework from misuse; it does not answer the excluded question. |
| Report quality and evidence discipline | Score generated reports for scope clarity, stakeholder mapping, principle/domain traceability, evidence reviewed, missing evidence, validation gaps, and claim boundaries. | A high-quality report supports design reasoning and traceability, not product certification. |
| Moral-diff and implementation review | Use controlled code, documentation, configuration, policy, and commit-diff scenarios with known privacy, truthfulness, accessibility, security, lock-in, or promise-keeping issues. | Detecting issues in test scenarios would support review usefulness, not deployed operational success. |
| Deterministic gate enforcement | Connect structured `i-vsd` findings to an Assay-style policy gate and test whether `CRITICAL` and `WARNING` thresholds produce stable pass/fail outcomes across repeated runs. | Stable gate behavior would support workflow reliability, not prove that every finding is substantively correct. |
| CI/CD lifecycle integration | Run the same policy through local pre-commit hooks, pull-request checks, and protected-branch deployment gates. Compare developer feedback, evidence preservation, false positives, false negatives, and escalation handling. | CI/CD enforcement would show that I-VSD review can become operational infrastructure; it would not turn the pipeline into moral, legal, or Islamic certification. |
| Baseline comparison | Compare the skill against checklist-only review, ordinary code review, legal-compliance-only review, standard VSD prompts, and non-I-VSD AI review prompts. | Baseline improvement would be evidence for the artifact's utility, not proof of stakeholder or scholarly validation. |

![figure future research comparaison matrix i vsd enforcement](../30-Resources/Thesis/figure_future-research-comparaison-matrix-i-vsd-enforcement.png)

**Alt text/textual equivalent:** Comparison matrix contrasting checklist-only review, ordinary AI code review, the current `i-vsd` skill, and an Assay-backed I-VSD gate across moral review, evidence discipline, structured severity output, deterministic enforcement, lifecycle integration, evidence bundles, escalation boundaries, and certification claims.

![figure future evaluation agentic skill](../30-Resources/Thesis/figure_future-evaluation-agentic-skill.png)

**Alt text/textual equivalent:** Multi-lane diagram showing future evaluation paths for the `i-vsd` skill, including host-repository adoption, agent-independent use, refusal tests, report quality, moral-diff review, and baseline comparisons.
...
Future work should turn these categories into explicit protocols rather than broad aspirations. A reproducible validation program could use three layers:

| Validation layer | Purpose | Participants or artifacts | Protocol design | Evidence produced | Boundary |
| --- | --- | --- | --- | --- | --- |
| Normative validity | Test whether I-VSD's selected principles, non-negotiables, and trade-off rules are responsibly specified. | Contemporary Islamic scholars within the stated Sunni scope, software practitioners, privacy/security reviewers, accessibility reviewers, and written source justifications. | Scenario review, contradiction tests, pairwise trade-off tasks, red-line classification, scholar-practitioner review panels, and disagreement analysis. | Review memos, coded disagreement records, revised principle-role mappings, unresolved-question logs, and escalation criteria. | This would support scholarly scrutiny; it would not by itself constitute a fatwa, Sharia certification, or complete Islamic legal ruling. |
| System and design performance | Test whether I-VSD improves design reasoning, traceability, and control selection compared with alternative review approaches. | Practitioners, prototype tasks, design alternatives, architecture decisions, UI flows, policy drafts, prompts, and review artifacts. | Compare I-VSD-guided reviews with a performance-only baseline, a legal-compliance-only baseline, standard VSD, and ablations that remove specific I-VSD controls such as red-line checks, traceability matrices, or stakeholder-harm prompts. Use think-alouds, task completion analysis, consistency scoring, and independent reviewer assessment. | Traceability completeness, requirement/control coverage, decision consistency, privacy/security/accessibility issue detection, recourse clarity, fairness or robustness metrics where a model or ranking component exists, and time-to-review measures. | These tests would evaluate review performance and design quality indicators; they would not prove that the deployed system is morally successful. |
| Socio-technical impact | Test how the framework works in lived use after design decisions enter organizational practice. | Organizers, attendees, administrators, developers, community representatives, vulnerable or affected stakeholders, support records, audit logs, appeal records, incident records, and deployment data. | Interviews, surveys, participatory workshops, longitudinal field records, operational audits, accessibility checks, privacy/security audits, incident review, appeal review, and subgroup analysis where relevant. | Stakeholder understanding, perceived legitimacy, reported harms, support burden, incident rates, appeal outcomes, accessibility outcomes, privacy/security findings, portability outcomes, and governance-revision records. | These studies would be context-specific and would still need careful interpretation, especially where adoption, trust, or satisfaction is shaped by factors beyond I-VSD. |

The technical evaluation layer should be designed before deployment where possible. Future researchers could define a pre-registered evaluation matrix that names the baseline, ablation, metric, evidence source, expected limitation, and decision rule for each claim. For example, a privacy-first architecture claim could be evaluated through data-minimization checks, permission-scope review, audit-log inspection, and privacy-risk assessment. An accessibility claim could be evaluated through WCAG-oriented checks, assistive-technology walkthroughs, localization review, and user testing with affected participants. A fairness or ranking claim, if future AI or recommendation features are added, could use appropriate subgroup metrics, equality-of-opportunity or equalized-odds tests, individual-fairness checks, counterfactual tests, calibration analysis, and qualitative recourse review. Security claims would require threat modeling, dependency review, access-control tests, incident-response exercises, and longitudinal incident records.

Where public or synthetic datasets are useful, they should be chosen because they fit a specific evaluation claim rather than because they are well known. Possible future domains include medical triage or administrative examples using datasets such as MIMIC-IV or CheXpert/CheXpert Plus, lending or public-sector decision examples using HMDA, COMPAS, or completed Canada Algorithmic Impact Assessment materials, and value-labeled conversational or LLM-assistant logs for software-governance scenarios. These would be future testbeds only; they would not replace stakeholder consultation, Islamic scholarly review, or deployment-specific audit evidence.

A later reproducibility package should include:

| Component | Function |
| --- | --- |
| Public or synthetic tasks | Let other researchers repeat design-review, trade-off, and contradiction-test scenarios without exposing private organizational data. |
| Pre-registered evaluation matrix | State claims, baselines, ablations, metrics, evidence sources, and decision rules before results are known. |
| Versioned datasets, prompts, rubrics, and scenarios | Preserve the exact inputs used for stakeholder studies, practitioner reviews, AI-assistant tests, or governance audits. |
| Traceability matrix | Link each selected principle to norms, requirements, controls, metrics, evidence objects, and unresolved limitations. |
| Metrics and ablation code | Allow replication of technical measures, baseline comparisons, sensitivity checks, and fairness/privacy/security/accessibility tests where software artifacts exist. |
| Datasheets and artifact documentation | Describe dataset origin, collection limits, intended use, known risks, exclusions, and maintenance responsibilities. |
| Ethics appendix | Record consent, participant risk, privacy safeguards, scholar/practitioner review boundaries, deployment limits, and conditions under which results should not be generalized. |
...
- Can an Assay-backed I-VSD gate make moral-diff review enforceable in local commits, pull requests, and CI/CD without collapsing moral reasoning into opaque automation or overclaiming certification?
...
Future work should explore tools that help practitioners apply I-VSD without pretending that ethics can be fully automated. A practical ecosystem could extend the existing `i-vsd` AI-agent skill with a CLI that gathers project context and flags likely ethical risks, an MCP/API service connected to curated framework guidance, testing libraries for concrete anti-patterns, report-versioning support, and consultancy or training programs for teams that need human judgment.

The practical tooling path should preserve the skill's agent-agnostic design. A CLI, MCP/API service, or IDE integration should not replace the resource library with opaque automation; it should help agents and practitioners find the relevant resources, collect evidence, choose routed actions, update persistent reports, and preserve refusal and escalation rules. In this sense, future tooling would extend the thesis artifact rather than change it into a certification engine.

Future work should also explore an I-VSD-oriented trust center pattern. Such a pattern would go beyond displaying common compliance badges by separating implemented controls, self-assessments, external audits, subprocessors, known limitations, incident-response expectations, data-rights workflows, and moral-review notes. This could make trust evidence more accessible for small organizations that cannot yet afford expensive audit platforms, while still making clear that a trust center is not legal certification, Sharia certification, or proof of moral compliance.
...
- Al-Shatibi, Abu Ishaq. (c. 14th century). Al-Muwafaqat fi Usul al-Sharia.
- Ibn Taymiyyah, Ahmad ibn Abd al-Halim. (c. 14th century). Al-Hisbah fi al-Islam.
...
- Le Dantec, C. A., Poole, E. S., & Wyche, S. P. (2009). Values as Lived Experience: Evolving Value Sensitive Design in Support of Value Discovery. In Proceedings of CHI '09.
- Borning, A., & Muller, M. (2012). Next Steps for Value Sensitive Design. In Proceedings of CHI '12, 1125-1134.
- van den Hoven, J. (2007). ICT and Value Sensitive Design. In The Information Society: Innovation, Legitimacy, Ethics and Democracy. Springer.
- Jacobs, N. (2020). Capability Sensitive Design for Health and Wellbeing Technologies. Science and Engineering Ethics, 26, 3363-3391.
...
- Spiekermann, S., & Winkler, T. (2022). Value-based Engineering with IEEE 7000. IEEE Technology and Society Magazine.
...
### Academic Sources: Design Science and Accountability
...
### Industry Sources
- Kotlin. (n.d.). *Stability of supported platforms*. https://kotlinlang.org/docs/multiplatform/supported-platforms.html
- Kotlin. (n.d.). *Compose Multiplatform*. https://kotlinlang.org/compose-multiplatform/
- CrowdSec. (n.d.). *Security Engine*. https://docs.crowdsec.net/security-engine/
- Bugaev, L. (2026). *Death of Security by Obscurity*. The Verification Gap. https://blog.reqproof.com/p/death-of-security-by-obscurity
- Mozilla. (2025). *Introducing a terms of use and updated privacy notice for Firefox*. The Mozilla Blog. https://blog.mozilla.org/en/firefox/firefox-terms-of-use
- Mozilla. (2025). *An update on our terms of use*. The Mozilla Blog. https://blog.mozilla.org/en/firefox/update-on-terms-of-use
- ROOST. (n.d.). *Osprey*. https://roost.tools/osprey
- ROOST. (n.d.). *Osprey GitHub repository*. https://github.com/roostorg/osprey
- Tailscale. (2026). *Configure Tailscale clients to use a custom control server*. https://tailscale.com/docs/how-to/set-up-custom-control-server
- Headscale. (n.d.). *Android*. https://headscale.net/stable/usage/connect/android/
- Headscale. (n.d.). *Apple*. https://docs.headscale.org/usage/connect/apple/
- Headscale. (n.d.). *Windows*. https://docs.headscale.org/usage/connect/windows/
- PeerTube Documentation. (n.d.). *The platforms tab*. https://docs.joinpeertube.org/use-mobile/platforms
- PeerTube Documentation. (n.d.). *Get the app*. https://docs.joinpeertube.org/use-mobile/get-the-app

- Center for Humane Technology. (n.d.). About CHT. https://www.humanetech.com/
- Acceptable Ads Committee. (n.d.). Acceptable Ads Standards. https://acceptableads.com/
...
- Federal Trade Commission. (2019). Disclosures 101 for Social Media Influencers. https://www.ftc.gov/business-guidance/resources/disclosures-101-social-media-influencers
...
- Free Software Foundation. (2026). You cannot use the GNU (A)GPL to take software freedom away. https://www.fsf.org/blogs/licensing/agpl-is-not-a-tool-for-taking-freedom-away
- Carnegie Mellon University. (2025). Fraudsters Use Fake Stars To Game GitHub. https://www.cs.cmu.edu/news/2025/fake-github-stars
- arXiv. (2024). Six Million Suspected Fake Stars on GitHub. https://arxiv.org/abs/2412.13459

- Mistral AI. (n.d.). About Mistral AI. https://mistral.ai/about
- Axios. (2026). Reporting on Anthropic no-kill-switch classified-network filing. https://www.axios.com/2026/04/22/anthropic-no-kill-switch-ai-classified-settings
- Railway. (2026). Your AI wants to nuke your database. https://blog.railway.com/p/your-ai-wants-to-nuke-your-database
- The Verge. (2026). PocketOS maker says an AI agent deleted a production database in 9 seconds. https://www.theverge.com/ai-artificial-intelligence/919240/pocketos-maker-says-an-ai-agent-deleted-our-production-database-in-9-seconds
- Business Insider. (2026). PocketOS/Cursor AI agent deleted production database coverage. https://www.businessinsider.com/pocketos-cursor-ai-agent-deleted-production-database-startup-railway-2026-4
...
- GitHub DMCA Repository. (2025). FFmpeg / Rockchip MPP notice. https://github.com/github/dmca/blob/master/2025/12/2025-12-18-ffmpeg.md
- Rockchip MPP issue #530. (2024). LGPL/license-compliance allegation discussion. https://github.com/rockchip-linux/mpp/issues/530
- HermanChen MPP issue #73. Maintainer response to license-compliance concerns. https://github.com/HermanChen/mpp/issues/73
...
- OpenAI valuation and announcement analysis: https://www.wheresyoured.at/oracle-openai/
- Muslim Charities Forum. (2025). "The Landscape of Debanking within Muslim Charities and its Impact on Charitable Activities." https://www.muslimcharitiesforum.org.uk/resources/
...
- IEEE. Code of Ethics.
- IEEE. (2021). IEEE Std 7000-2021: Model Process for Addressing Ethical Concerns during System Design.
...
- Treasury Board of Canada Secretariat. (n.d.). Algorithmic Impact Assessment tool.


- W3C. (n.d.). *Using ARIA: First rule of ARIA use*. https://www.w3.org/TR/using-aria/#firstrule
- Chrome Developers. (n.d.). *Accessible carousel guidance*. https://developer.chrome.com/blog/accessible-carousel
- Boxhall, A. (n.d.). *A threat model for accessibility on the web*. https://alice.boxhall.au/articles/a-threat-model-for-accessibility-on-the-web/
...
- Johnson, E. J., & Goldstein, D. (2003). *Do defaults save lives?* Science, 302(5649), 1338–1339. https://www.science.org/doi/10.1126/science.1091721
...
- Westenberg, J. (2025). Every Decision Has Three Costs: Time, Focus, and Optionality. https://www.joanwestenberg.com/

- International Consumer Protection and Enforcement Network. (2024, July 2). *ICPEN Dark Patterns Sweep Public Report*. https://www.icpen.org/sites/default/files/2024-07/Public%20Report%20ICPEN%20Dark%20Patterns%20Sweep.pdf
- International Consumer Protection and Enforcement Network. (2024, July 9). *ICPEN Sweep Finds Dark Patterns Used on Most Subscription Service Websites and Apps*. https://www.icpen.org/news/1360

- Organisation for Economic Co-operation and Development. (2022). *Dark Commercial Patterns* (OECD Digital Economy Papers No. 336). Local thesis reference PDF: Dark Commercial Patterns.pdf.

### Open Source Governance and Case Studies

- Linux Foundation. (2024). Valkey: Community Fork of Redis. https://valkey.io/
- Redis Labs. (2024). License Change Announcement. https://redis.com/
...
- JetBrains. (2026, May 27). *Zig 2026: No-AI Policy, $670K Foundation, Left GitHub & Why Zig Isn't 1.0 - Andrew Kelley Explains* [Video]. YouTube. https://www.youtube.com/watch?v=iqddnwKF8HQ

- MonoGame. (2025). New Sponsor Announcement. https://monogame.net/blog/2025-12-30-385-new-sponsor-announcement/
- MonoGame. (n.d.). About MonoGame. https://monogame.net/about/
- Re-Logic. (2023). Statement Regarding Unity & The Future. https://forums.terraria.org/index.php?threads/re-logic-statement-regarding-unity-the-future.129041/

- IndieWeb. (n.d.). Site deaths. https://indieweb.org/site-deaths
- IndieWeb. (n.d.). Lost sites. https://indieweb.org/lost_sites
- The Spinner. (2019 archived snapshot). https://web.archive.org/web/20190927174004/https://www.thespinner.net/
- Clawd.rip. (2026). Claude Code incident timeline. https://clawd.rip/
- Anthropic. (2026). April 23 postmortem. https://www.anthropic.com/engineering/april-23-postmortem
- Anthropic Claude Code GitHub issue #53262. https://github.com/anthropics/claude-code/issues/53262

- Ladybird. (n.d.). *Ladybird — A truly independent web browser*. https://ladybird.org/
- Ladybird. (n.d.). *Ladybird sponsors and public project updates*. https://ladybird.org/news/
- Mobilizon. (n.d.). *Mobilizon: online platforms to create, share and find events*. https://mobilizon.org/
- Mobilizon. (n.d.). *About Mobilizon*. https://mobilizon.org/about/
- Mobilizon Documentation. (n.d.). *Federation with ActivityPub*. https://docs.mobilizon.org/5.%20Interoperability/1.activity_pub/
- Mobilizon Documentation. (n.d.). *Flux RSS/Atom & Flux ICS/WebCal*. https://docs.mobilizon.org/5.%20Interoperability/4.flux_rss_ics/

### Digital Media and Internet Analysis

- The Dead Internet Theory. (2024). Video analysis and community documentation. https://youtu.be/YwdVSp8gOt4
- Bongers, C. (2025). I Love My Job and It's Exhausting. CodeCabin. https://www.codecabin.dev/
...
![figure practitioner workflow for i vsd](../30-Resources/Thesis/figure_practitioner-workflow-for-i-vsd.png)

**Alt text/textual represenatation** A process flowchart titled 'Practitioner Workflow for Applying I-VSD.' It shows a step-by-step sequence starting with identifying a software decision and stakeholders, mapping relevant Islamic principles to a domain, selecting a heuristic, documenting tradeoffs, and defining the required evidence level. Review loops are triggered at tradeoff points or evidence gaps, leading to a final stage for documentation and future validation. A note clarifies the workflow serves as a practical procedural guide rather than a universally validated model.

#### Practitioner workflow and report contract reference

The same workflow can also support agentic I-VSD review reports, where a practitioner or AI-assisted reviewer moves from a concrete provider decision to a bounded traceability record. The report contract should preserve the thesis claim boundary: it documents I-VSD design reasoning, evidence gaps, implementation traceability, and escalation needs; it does not issue a fatwa, certify a product as Sharia-compliant, or prove stakeholder or operational outcomes.

| Workflow stage | Practitioner question | Report trace |
|---|---|---|
| Decision and scope | What provider-mediated software decision, feature, policy, business model, or implementation change is being reviewed? | Scope and context inventory |
| Stakeholders and principles | Which direct, indirect, vulnerable, provider-side, partner, future, and non-user stakeholders are affected, and which I-VSD principles are relevant? | Stakeholders and I-VSD principles/domains |
| Domain and heuristic | Which strategic, design, technical, operational, governance, or evaluation domain frames the decision, and which heuristic follows from the framework? | Findings and recommendations |
| Evidence and tradeoff | What evidence supports the finding, what evidence is missing, and which growth, convenience, automation, or cost alternatives were rejected? | Evidence reviewed, missing evidence, validation gaps, and escalation needed |
...
**Sources:**
- YouTube analysis: https://youtu.be/KVyCKFk4hcQ?si=Q7DUVHVdIxhmYV9h
...
*Islamic Perspective: See Section 2.1.3.Z for consolidated Islamic guidance on deception and fraudulent software.*
...
Providers that market absolute privacy should disclose a fundamental limitation: no software service can guarantee 100% privacy in every threat model. Technical limitations that can undermine privacy claims include AI-guided traffic analysis, fingerprinting through OS, browser, window size, WebGL rendering, and processor/GPU information, VPN providers that log details or cooperate with authorities, Tor network vulnerabilities when the same entity owns entry and exit nodes, user errors that break anonymity such as inputting identifiable information, malware or spyware on user devices, and behavioral patterns unique to individual users. (Sources: Mullvad VPN on AI-guided Traffic Analysis: https://mullvad.net/en/vpn/daita; Browser Fingerprinting explanation: https://youtu.be/piftpgsZE9g?si=aZrpaREWEnB1qdZQ)
...
Positive examples do exist. Organizations like the Acceptable Ads Committee establish ethical advertising standards (https://acceptableads.com/ and https://adblockplus.org/en/acceptable-ads#criteria), showing that alternative approaches are possible.
...
**Source:** Open Source Initiative. (n.d.). "The Open Source Definition (Annotated)." https://opensource.org/osd
...
**Sources:** Louis Rossmann videos on right to repair; Consumer Rights Wiki; FULU non-profit organization; https://www.wheresyoured.at/oracle-openai/

**2.1.3.19 Lack of Transparency**

Software service companies obscure pricing and terms, making informed decisions difficult or impossible. Warp's pricing provides an illustrative example—as one commentator noted, "you'll need a spreadsheet, a tarot deck, and possibly divine intervention" to understand it (Source: https://blog.kilocode.ai/p/warps-new-pricing-still-doesnt-add).
...
**Source:** Wired (2022). "Doxers Posing as Cops Are Tricking Big Tech Firms Into Sharing People's Private Data." https://www.wired.com/story/doxers-posing-as-cops-are-tricking-big-tech-firms-into-sharing-peoples-private-data
...
- Larjari, M. (2025). "Companies Are Blaming AI for Layoffs: The Real Reason Will Piss You Off." Medium. https://medium.com/@mattlar.jari/companies-are-blaming-ai-for-layoffs-the-real-reason-will-piss-you-off-149639ce47cf
...
- Henry, D. (2025). "The Unseen Scar: The Mental Health Toll of Tech Layoffs on Those Laid Off and Those Who Remain." LinkedIn. https://www.linkedin.com/pulse/unseen-scar-mental-health-toll-tech-layoffs-those-laid-dennis-henry-suiee/
...
| **PII Separation and Retention** | High | Can personally identifying data be separated, minimized, retained, deleted, and exported according to explicit reviewable rules? |
| **Auditability and Compliance Readiness** | High | Can security-sensitive, administrative, data-rights, and configuration changes be logged and reviewed without creating unnecessary surveillance? |
| **Enterprise Identity Boundaries** | Medium | Can future SSO, SAML, SCIM, or directory integrations preserve clear authority boundaries rather than weakening self-hosted control? |
...
| PII separation and data rights | PII-split modeling, consent-scoped contact sharing, data access/deletion/export workflows, and retention review should be treated as architectural concerns | Supports GDPR-oriented review, Trust, data minimization, and user control | These choices support reviewability; they do not prove legal compliance or privacy outcomes. |
| Enterprise readiness | Audit logs, SSO/SAML/SCIM-style identity integration, directory synchronization, trust-center evidence, and shared-responsibility documentation remain readiness criteria unless current implementation evidence verifies them | Supports enterprise review without hiding operator responsibilities | Do not claim SOC 2, ISO 27001, HIPAA, FedRAMP, GDPR compliance, or complete enterprise readiness without audit and legal evidence. |
...
When you start focusing on something, you begin to see it everywhere. Before that, you may not even notice it or give it any attention. It is like deciding to look for white cars: suddenly, it feels as if there are far more white cars around than you ever realized, simply because you had never paid attention to them before.

That is exactly how I felt while working on this thesis about the moral and ethical dimensions of software services and solutions. During these months, I have constantly encountered practices that felt immoral, unethical, or at least worthy of serious questioning. This process has made me more critical of the software I use, the companies I rely on, the trust I give out, and the skepticism I now carry with me.

At the same time, I have also seen awareness around these issues grow, and that gives me hope for the future. I realized that the scale of the problem is bigger than I first thought, but a bigger challenge also means that work done to address it can have greater value. I find meaning in that. It connects directly to the nonprofit organization I am working on and to the software being developed within it. Seeing that this awareness is rising has therefore not discouraged me; it has motivated me even more to focus on this work.

I am still not fully satisfied with the thesis, because the subject itself is non-exhaustive. There are so many directions this work could still take, and I would have liked to include an even broader scholarly review and develop many parts further. In several places, the thesis points to future work, additional development, or ways in which a section could benefit from more depth. Part of me wishes it could already be fully finished in all of those ways. Still, I am proud of where it stands now, and I know I will continue working on it.

I want to thank Patrick for his feedback, which helped shape the thesis into what it is today.
